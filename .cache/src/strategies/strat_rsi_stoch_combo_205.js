...
exports.RsiStochCombo205Strategy = void 0;
...
class RsiStochCombo205Strategy {
    constructor(params = {}) {
        ...
        this.stochPriceHistory = new Map();
        this.kValues = new Map();
        this.divergenceSignalBar = new Map();
        this.stochSignalBar = new Map();
        this.entryPrice = new Map();
        this.barCount = new Map();
...
exports.RsiStochCombo205Strategy = RsiStochCombo205Strategy;
