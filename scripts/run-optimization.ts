...
import { SRNoTrendMultiExit305Strategy } from '../src/strategies/strat_sr_no_trend_multi_exit_305';
import { SRTightMomentum306Strategy } from '../src/strategies/strat_sr_tight_momentum_306';
import { SRLooseMomentum307Strategy } from '../src/strategies/strat_sr_loose_momentum_307';
import { SRNoTrendWideStoch308Strategy } from '../src/strategies/strat_sr_no_trend_wide_stoch_308';
import { SRNoTrendTightStoch309Strategy } from '../src/strategies/strat_sr_no_trend_tight_stoch_309';
import { SRNoTrendTwoBounce310Strategy } from '../src/strategies/strat_sr_no_trend_two_bounce_310';
import { SRNoTrendLowerRisk311Strategy } from '../src/strategies/strat_sr_no_trend_lower_risk_311';
import { SRNoTrendHigherProfit312Strategy } from '../src/strategies/strat_sr_no_trend_higher_profit_312';
...
const strategies: Record<string, { class: any; params: Record<string, ParamConfig>; outputFile: string }> = {
  ...
  sr_ntf_v16_001: {
    ...
    params: {
      lookback: { min: 8, max: 36, stepSize: 4 },
      bounce_threshold: { min: 0.01, max: 0.08, stepSize: 0.01 },
      stop_loss: { min: 0.02, max: 0.10, stepSize: 0.01 },
      risk_percent: { min: 0.05, max: 0.35, stepSize: 0.05 },
      take_profit: { min: 0.05, max: 0.20, stepSize: 0.01 },
    },
    outputFile: 'strat_sr_ntf_v16_001.params.json',
  },
  sr_ntf_v16_002: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_002.params.json',
  },
  sr_ntf_v16_003: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_003.params.json',
  },
  sr_ntf_v16_004: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_004.params.json',
  },
  sr_ntf_v16_005: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_005.params.json',
  },
  sr_ntf_v16_006: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_006.params.json',
  },
  sr_ntf_v16_007: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_007.params.json',
  },
  sr_ntf_v16_008: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_008.params.json',
  },
  sr_ntf_v16_009: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_009.params.json',
  },
  sr_ntf_v16_010: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_010.params.json',
  },
  sr_ntf_v16_011: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_011.params.json',
  },
  sr_ntf_v16_012: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_012.params.json',
  },
  sr_ntf_v16_013: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_013.params.json',
  },
  sr_ntf_v16_014: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_014.params.json',
  },
  sr_ntf_v16_015: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_015.params.json',
  },
  sr_ntf_v16_016: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_016.params.json',
  },
  sr_ntf_v16_017: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_017.params.json',
  },
  sr_ntf_v16_018: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_018.params.json',
  },
  sr_ntf_v16_019: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_019.params.json',
  },
  sr_ntf_v16_020: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_020.params.json',
  },
  sr_ntf_v16_021: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_021.params.json',
  },
  sr_ntf_v16_022: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_022.params.json',
  },
  sr_ntf_v16_023: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_023.params.json',
  },
  sr_ntf_v16_024: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_024.params.json',
  },
  sr_ntf_v16_025: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_025.params.json',
  },
  sr_ntf_v16_026: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_026.params.json',
  },
  sr_ntf_v16_027: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_027.params.json',
  },
  sr_ntf_v16_028: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_028.params.json',
  },
  sr_ntf_v16_029: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_029.params.json',
  },
  sr_ntf_v16_030: {
    class: SRNoTrendFilter302Strategy,
    params: {
    ...
    outputFile: 'strat_sr_ntf_v16_030.params.json',
  },
  momentum: {
  ...
  sr_no_trend_multi_exit_305: {
    class: SRNoTrendMultiExit305Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
      volatility_period: { min: 8, max: 16, stepSize: 2 },
      bounce_threshold: { min: 0.015, max: 0.035, stepSize: 0.005 },
      stoch_k_period: { min: 12, max: 22, stepSize: 2 },
      stoch_d_period: { min: 3, max: 7, stepSize: 1 },
      stoch_oversold: { min: 18, max: 30, stepSize: 2 },
      stoch_overbought: { min: 80, max: 92, stepSize: 2 },
      momentum_period: { min: 2, max: 5, stepSize: 1 },
      momentum_threshold: { min: 0.002, max: 0.012, stepSize: 0.002 },
      min_bounce_bars: { min: 1, max: 2, stepSize: 1 },
      stop_loss: { min: 0.05, max: 0.10, stepSize: 0.01 },
      trailing_stop: { min: 0.05, max: 0.09, stepSize: 0.01 },
      profit_target: { min: 0.10, max: 0.20, stepSize: 0.02 },
      partial_profit_target: { min: 0.04, max: 0.10, stepSize: 0.02 },
      partial_exit_pct: { min: 0.3, max: 0.5, stepSize: 0.1 },
      max_hold_bars: { min: 24, max: 40, stepSize: 4 },
      risk_percent: { min: 0.22, max: 0.38, stepSize: 0.04 },
    },
    outputFile: 'strat_sr_no_trend_multi_exit_305.params.json',
  },
  sr_tight_momentum_306: {
    class: SRTightMomentum306Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
      ...
      stoch_overbought: { min: 80, max: 92, stepSize: 2 },
      momentum_period: { min: 2, max: 5, stepSize: 1 },
      momentum_threshold: { min: 0.008, max: 0.020, stepSize: 0.003 },
      min_bounce_bars: { min: 1, max: 2, stepSize: 1 },
      stop_loss: { min: 0.05, max: 0.10, stepSize: 0.01 },
      trailing_stop: { min: 0.05, max: 0.09, stepSize: 0.01 },
    ...
    outputFile: 'strat_sr_tight_momentum_306.params.json',
  },
  sr_loose_momentum_307: {
    class: SRLooseMomentum307Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
      ...
      stoch_overbought: { min: 80, max: 92, stepSize: 2 },
      momentum_period: { min: 2, max: 5, stepSize: 1 },
      momentum_threshold: { min: 0.000, max: 0.006, stepSize: 0.001 },
      min_bounce_bars: { min: 1, max: 2, stepSize: 1 },
      stop_loss: { min: 0.05, max: 0.10, stepSize: 0.01 },
      trailing_stop: { min: 0.05, max: 0.09, stepSize: 0.01 },
      profit_target: { min: 0.10, max: 0.18, stepSize: 0.02 },
    ...
    outputFile: 'strat_sr_loose_momentum_307.params.json',
  },
  sr_no_trend_wide_stoch_308: {
    class: SRNoTrendWideStoch308Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
      ...
      stoch_d_period: { min: 3, max: 7, stepSize: 1 },
      stoch_oversold: { min: 25, max: 35, stepSize: 2 },
      stoch_overbought: { min: 85, max: 95, stepSize: 2 },
      momentum_period: { min: 2, max: 5, stepSize: 1 },
      momentum_threshold: { min: 0.002, max: 0.012, stepSize: 0.002 },
      min_bounce_bars: { min: 1, max: 2, stepSize: 1 },
      stop_loss: { min: 0.05, max: 0.10, stepSize: 0.01 },
    ...
    outputFile: 'strat_sr_no_trend_wide_stoch_308.params.json',
  },
  sr_no_trend_tight_stoch_309: {
    class: SRNoTrendTightStoch309Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
      ...
      stoch_d_period: { min: 3, max: 7, stepSize: 1 },
      stoch_oversold: { min: 12, max: 22, stepSize: 2 },
      stoch_overbought: { min: 75, max: 85, stepSize: 2 },
      momentum_period: { min: 2, max: 5, stepSize: 1 },
      momentum_threshold: { min: 0.002, max: 0.012, stepSize: 0.002 },
      min_bounce_bars: { min: 1, max: 2, stepSize: 1 },
      stop_loss: { min: 0.05, max: 0.10, stepSize: 0.01 },
    ...
    outputFile: 'strat_sr_no_trend_tight_stoch_309.params.json',
  },
  sr_no_trend_two_bounce_310: {
    class: SRNoTrendTwoBounce310Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
      ...
      momentum_period: { min: 2, max: 5, stepSize: 1 },
      momentum_threshold: { min: 0.002, max: 0.012, stepSize: 0.002 },
      min_bounce_bars: { min: 2, max: 3, stepSize: 1 },
      stop_loss: { min: 0.05, max: 0.10, stepSize: 0.01 },
      trailing_stop: { min: 0.05, max: 0.09, stepSize: 0.01 },
      profit_target: { min: 0.10, max: 0.18, stepSize: 0.02 },
      max_hold_bars: { min: 24, max: 40, stepSize: 4 },
    ...
    outputFile: 'strat_sr_no_trend_two_bounce_310.params.json',
  },
  sr_no_trend_lower_risk_311: {
    class: SRNoTrendLowerRisk311Strategy,
    params: {
      base_lookback: { min: 14, max: 28, stepSize: 2 },
      min_lookback: { min: 8, max: 16, stepSize: 2 },
      max_lookback: { min: 28, max: 44, stepSize: 4 },
