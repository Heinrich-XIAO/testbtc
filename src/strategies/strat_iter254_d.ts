...
export interface StratIter254DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter254DStrategy extends BaseIterStrategy<StratIter254DParams> {
  constructor(params: Partial<StratIter254DParams> = {}) {
    super('strat_iter254_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 30, risk: 0.7 }, params);
  }
