...
// 45 bar hold, 50% profit, 12% stop, 60% risk, 1.5% drop
...
export interface StratIter247EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter247EStrategy extends BaseIterStrategy<StratIter247EParams> {
  constructor(params: Partial<StratIter247EParams> = {}) {
    super('strat_iter247_e.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.5, max_hold: 45, risk: 0.6000000000000001 }, params);
  }
