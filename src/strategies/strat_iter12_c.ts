...
export interface StratIter12CParams extends StrategyParams {
...
const defaultParams: StratIter12CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter12CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter12_c.params.json');
...
export class StratIter12CStrategy implements Strategy {
  params: StratIter12CParams;
  ...
  constructor(params: Partial<StratIter12CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter12CParams;
  }
