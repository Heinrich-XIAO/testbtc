...
export interface StratIter192BParams extends StrategyParams { rsi_period: number; rsi_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter192BStrategy extends BaseIterStrategy<StratIter192BParams> {
  constructor(params: Partial<StratIter192BParams> = {}) { super('strat_iter192_b.params.json', { rsi_period: 7, rsi_oversold: 30, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
