...
export interface StratIter254EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter254EStrategy extends BaseIterStrategy<StratIter254EParams> {
  constructor(params: Partial<StratIter254EParams> = {}) {
    super('strat_iter254_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.45, max_hold: 25, risk: 0.7 }, params);
  }
