...
// 45 bar hold, 50% profit, 12% stop, 20% risk, 1.0% drop
...
export interface StratIter247AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter247AStrategy extends BaseIterStrategy<StratIter247AParams> {
  constructor(params: Partial<StratIter247AParams> = {}) {
    super('strat_iter247_a.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.5, max_hold: 45, risk: 0.2 }, params);
  }
