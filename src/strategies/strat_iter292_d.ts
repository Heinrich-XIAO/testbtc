...
export interface StratIter292DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter292DStrategy extends BaseIterStrategy<StratIter292DParams> {
  constructor(params: Partial<StratIter292DParams> = {}) {
    super('strat_iter292_d.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
