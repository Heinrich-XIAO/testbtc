...
export interface StratIter189CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter189CStrategy extends BaseIterStrategy<StratIter189CParams> {
  constructor(params: Partial<StratIter189CParams> = {}) { super('strat_iter189_c.params.json', { fast_period: 20, slow_period: 50, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
