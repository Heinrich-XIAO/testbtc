...
export interface StratIter282CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter282CStrategy extends BaseIterStrategy<StratIter282CParams> {
  constructor(params: Partial<StratIter282CParams> = {}) {
    super('strat_iter282_c.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
