...
// Grid: 1.0% drop, 15% stop, 25% profit, 35 hold, 50% risk
...
export interface StratIter269CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter269CStrategy extends BaseIterStrategy<StratIter269CParams> {
  constructor(params: Partial<StratIter269CParams> = {}) {
    super('strat_iter269_c.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
