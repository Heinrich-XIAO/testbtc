...
// 45% profit target with 12% stop loss
...
export interface StratIter213EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter213EStrategy extends BaseIterStrategy<StratIter213EParams> {
  constructor(params: Partial<StratIter213EParams> = {}) {
    super('strat_iter213_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
