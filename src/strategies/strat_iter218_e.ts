...
// 50% profit, 10% stop, 35 hold, 50% risk
...
export interface StratIter218EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter218EStrategy extends BaseIterStrategy<StratIter218EParams> {
  constructor(params: Partial<StratIter218EParams> = {}) {
    super('strat_iter218_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.5 }, params);
  }
