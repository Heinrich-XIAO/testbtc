...
// 50% profit, 12% stop, 40 hold, 30% risk
...
export interface StratIter220AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter220AStrategy extends BaseIterStrategy<StratIter220AParams> {
  constructor(params: Partial<StratIter220AParams> = {}) {
    super('strat_iter220_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.3 }, params);
  }
