...
export interface StratIter267AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter267AStrategy extends BaseIterStrategy<StratIter267AParams> {
  constructor(params: Partial<StratIter267AParams> = {}) {
    super('strat_iter267_a.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
