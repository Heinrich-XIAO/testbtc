...
export const optimizationConfig = {
  imf_lookback: { min: 25, max: 55, stepSize: 5 },
  imf_energy_ratio_threshold: { min: 0.4, max: 0.9, stepSize: 0.1 },
  imf_trend_threshold: { min: 0.005, max: 0.02, stepSize: 0.005 },
...
export const outputFile = 'strat_iter64_e.params.json';
