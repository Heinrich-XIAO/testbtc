...
// 1.5% drop, 8% trail, 8% stop, 40 hold, 45% risk
...
export interface StratIter240EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter240EStrategy extends BaseIterStrategy<StratIter240EParams> {
  constructor(params: Partial<StratIter240EParams> = {}) {
    super('strat_iter240_e.params.json', { drop_pct: 0.015, stop_loss: 0.08, trailing_stop: 0.08, max_hold: 40, risk: 0.45 }, params);
  }
