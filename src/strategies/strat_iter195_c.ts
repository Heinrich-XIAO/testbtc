...
export interface StratIter195CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter195CStrategy extends BaseIterStrategy<StratIter195CParams> {
  constructor(params: Partial<StratIter195CParams> = {}) { super('strat_iter195_c.params.json', { fast_period: 50, slow_period: 100, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
