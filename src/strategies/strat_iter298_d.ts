...
export interface StratIter298DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter298DStrategy extends BaseIterStrategy<StratIter298DParams> {
  constructor(params: Partial<StratIter298DParams> = {}) {
    super('strat_iter298_d.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
