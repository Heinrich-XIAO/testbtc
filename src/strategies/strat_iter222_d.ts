...
// 2% drop entry with 50% profit target
...
export interface StratIter222DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter222DStrategy extends BaseIterStrategy<StratIter222DParams> {
  constructor(params: Partial<StratIter222DParams> = {}) {
    super('strat_iter222_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
