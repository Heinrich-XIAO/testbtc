...
export interface StratIter5BParams extends StrategyParams {
...
const defaultParams: StratIter5BParams = {
  stoch_k_period: 14,
  stoch_oversold: 14,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter5BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter5_b.params.json');
...
export class StratIter5BStrategy implements Strategy {
  params: StratIter5BParams;
  ...
  constructor(params: Partial<StratIter5BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter5BParams;
  }
