...
export interface StratIter233AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter233AStrategy extends BaseIterStrategy<StratIter233AParams> {
  constructor(params: Partial<StratIter233AParams> = {}) {
    super('strat_iter233_a.params.json', { drop_pct: 0.03, stop_loss: 0.12, trailing_stop: 0.05, max_hold: 25, risk: 0.3 }, params);
  }
