...
export interface StratIter266AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter266AStrategy extends BaseIterStrategy<StratIter266AParams> {
  constructor(params: Partial<StratIter266AParams> = {}) {
    super('strat_iter266_a.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
