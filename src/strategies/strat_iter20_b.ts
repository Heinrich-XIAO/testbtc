...
export interface StratIter20BParams extends StrategyParams {
...
const defaultParams: StratIter20BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter20BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter20_b.params.json');
...
export class StratIter20BStrategy implements Strategy {
  params: StratIter20BParams;
  ...
  constructor(params: Partial<StratIter20BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter20BParams;
  }
