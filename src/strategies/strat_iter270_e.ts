...
export interface StratIter270EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter270EStrategy extends BaseIterStrategy<StratIter270EParams> {
  constructor(params: Partial<StratIter270EParams> = {}) {
    super('strat_iter270_e.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
