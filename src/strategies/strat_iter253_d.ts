...
export interface StratIter253DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter253DStrategy extends BaseIterStrategy<StratIter253DParams> {
  constructor(params: Partial<StratIter253DParams> = {}) {
    super('strat_iter253_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.45, max_hold: 25, risk: 0.6 }, params);
  }
