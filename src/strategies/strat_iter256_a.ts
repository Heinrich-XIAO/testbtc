...
// 45% risk, 1.0% drop, 40% profit, 8% stop, 25 hold
...
export interface StratIter256AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter256AStrategy extends BaseIterStrategy<StratIter256AParams> {
  constructor(params: Partial<StratIter256AParams> = {}) {
    super('strat_iter256_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 25, risk: 0.45 }, params);
  }
