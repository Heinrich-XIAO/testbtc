...
export interface StratIter289EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter289EStrategy extends BaseIterStrategy<StratIter289EParams> {
  constructor(params: Partial<StratIter289EParams> = {}) {
    super('strat_iter289_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
