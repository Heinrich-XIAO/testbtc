...
// 40 bar hold with 45% profit target
...
export interface StratIter242CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter242CStrategy extends BaseIterStrategy<StratIter242CParams> {
  constructor(params: Partial<StratIter242CParams> = {}) {
    super('strat_iter242_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 40, risk: 0.3 }, params);
  }
