...
// 75% risk, 2.5% drop, 50% profit, 12% stop, 30 hold
...
export interface StratIter259BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter259BStrategy extends BaseIterStrategy<StratIter259BParams> {
  constructor(params: Partial<StratIter259BParams> = {}) {
    super('strat_iter259_b.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.75 }, params);
  }
