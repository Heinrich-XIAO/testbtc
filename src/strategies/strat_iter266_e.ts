...
export interface StratIter266EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter266EStrategy extends BaseIterStrategy<StratIter266EParams> {
  constructor(params: Partial<StratIter266EParams> = {}) {
    super('strat_iter266_e.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
