...
export interface StratIter181BParams extends StrategyParams { rsi_period: number; rsi_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter181BStrategy extends BaseIterStrategy<StratIter181BParams> {
  constructor(params: Partial<StratIter181BParams> = {}) { super('strat_iter181_b.params.json', { rsi_period: 30, rsi_oversold: 30, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
