...
export interface StratIter255AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter255AStrategy extends BaseIterStrategy<StratIter255AParams> {
  constructor(params: Partial<StratIter255AParams> = {}) {
    super('strat_iter255_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 35, risk: 0.8 }, params);
  }
