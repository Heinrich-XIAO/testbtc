...
// 2.0% drop, 5% trail, 6% stop, 30 hold, 35% risk
...
export interface StratIter236CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter236CStrategy extends BaseIterStrategy<StratIter236CParams> {
  constructor(params: Partial<StratIter236CParams> = {}) {
    super('strat_iter236_c.params.json', { drop_pct: 0.02, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 30, risk: 0.35 }, params);
  }
