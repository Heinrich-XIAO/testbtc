...
export interface StratIter253BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter253BStrategy extends BaseIterStrategy<StratIter253BParams> {
  constructor(params: Partial<StratIter253BParams> = {}) {
    super('strat_iter253_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 30, risk: 0.6 }, params);
  }
