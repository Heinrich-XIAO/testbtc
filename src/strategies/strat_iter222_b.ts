...
export interface StratIter222BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter222BStrategy extends BaseIterStrategy<StratIter222BParams> {
  constructor(params: Partial<StratIter222BParams> = {}) {
    super('strat_iter222_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
