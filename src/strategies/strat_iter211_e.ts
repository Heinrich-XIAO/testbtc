...
// 35% profit target with 12% stop loss
...
export interface StratIter211EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter211EStrategy extends BaseIterStrategy<StratIter211EParams> {
  constructor(params: Partial<StratIter211EParams> = {}) {
    super('strat_iter211_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
