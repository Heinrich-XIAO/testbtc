...
export interface StratIter221EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter221EStrategy extends BaseIterStrategy<StratIter221EParams> {
  constructor(params: Partial<StratIter221EParams> = {}) {
    super('strat_iter221_e.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.3 }, params);
  }
