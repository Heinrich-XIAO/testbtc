...
export interface StratIter286BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter286BStrategy extends BaseIterStrategy<StratIter286BParams> {
  constructor(params: Partial<StratIter286BParams> = {}) {
    super('strat_iter286_b.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
