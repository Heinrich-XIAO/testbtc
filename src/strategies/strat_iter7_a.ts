...
export interface StratIter7AParams extends StrategyParams {
...
const defaultParams: StratIter7AParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter7AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter7_a.params.json');
...
export class StratIter7AStrategy implements Strategy {
  params: StratIter7AParams;
  ...
  constructor(params: Partial<StratIter7AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter7AParams;
  }
