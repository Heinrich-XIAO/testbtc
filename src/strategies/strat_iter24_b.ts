...
export interface StratIter24BParams extends StrategyParams {
...
const defaultParams: StratIter24BParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 52,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter24BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter24_b.params.json');
...
export class StratIter24BStrategy implements Strategy {
  params: StratIter24BParams;
  ...
  constructor(params: Partial<StratIter24BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter24BParams;
  }
