...
export interface StratIter210BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter210BStrategy extends BaseIterStrategy<StratIter210BParams> {
  constructor(params: Partial<StratIter210BParams> = {}) {
    super('strat_iter210_b.params.json', { drop_pct: 0.04, stop_loss: 0.10, profit_target: 0.25, max_hold: 25, risk: 0.25 }, params);
  }
