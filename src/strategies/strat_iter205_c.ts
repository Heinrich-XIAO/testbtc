...
export interface StratIter205CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter205CStrategy extends BaseIterStrategy<StratIter205CParams> {
  constructor(params: Partial<StratIter205CParams> = {}) {
    super('strat_iter205_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.30 }, params);
  }
