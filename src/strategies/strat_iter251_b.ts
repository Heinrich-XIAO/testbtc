...
export interface StratIter251BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter251BStrategy extends BaseIterStrategy<StratIter251BParams> {
  constructor(params: Partial<StratIter251BParams> = {}) {
    super('strat_iter251_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.4, max_hold: 25, risk: 0.4 }, params);
  }
