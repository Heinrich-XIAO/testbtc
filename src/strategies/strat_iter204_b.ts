...
export interface StratIter204BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter204BStrategy extends BaseIterStrategy<StratIter204BParams> {
  constructor(params: Partial<StratIter204BParams> = {}) {
    super('strat_iter204_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 10, risk: 0.25 }, params);
  }
