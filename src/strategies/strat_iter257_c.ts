...
// 55% risk, 1.5% drop, 45% profit, 10% stop, 35 hold
...
export interface StratIter257CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter257CStrategy extends BaseIterStrategy<StratIter257CParams> {
  constructor(params: Partial<StratIter257CParams> = {}) {
    super('strat_iter257_c.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.45, max_hold: 35, risk: 0.55 }, params);
  }
