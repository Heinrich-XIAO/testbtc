...
// 3.0% drop, 50% profit, 12% stop, 25 hold
...
export interface StratIter229AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter229AStrategy extends BaseIterStrategy<StratIter229AParams> {
  constructor(params: Partial<StratIter229AParams> = {}) {
    super('strat_iter229_a.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
