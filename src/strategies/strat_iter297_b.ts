...
export interface StratIter297BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter297BStrategy extends BaseIterStrategy<StratIter297BParams> {
  constructor(params: Partial<StratIter297BParams> = {}) {
    super('strat_iter297_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
