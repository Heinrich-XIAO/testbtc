...
// Grid: 2.5% drop, 12% stop, 50% profit, 30 hold, 40% risk
...
export interface StratIter290EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter290EStrategy extends BaseIterStrategy<StratIter290EParams> {
  constructor(params: Partial<StratIter290EParams> = {}) {
    super('strat_iter290_e.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
