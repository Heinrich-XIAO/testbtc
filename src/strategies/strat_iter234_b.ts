...
// 1.0% drop, 5% trail, 6% stop, 25 hold, 30% risk
...
export interface StratIter234BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter234BStrategy extends BaseIterStrategy<StratIter234BParams> {
  constructor(params: Partial<StratIter234BParams> = {}) {
    super('strat_iter234_b.params.json', { drop_pct: 0.01, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 25, risk: 0.3 }, params);
  }
