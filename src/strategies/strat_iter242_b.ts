...
// 40 bar hold with 40% profit target
...
export interface StratIter242BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter242BStrategy extends BaseIterStrategy<StratIter242BParams> {
  constructor(params: Partial<StratIter242BParams> = {}) {
    super('strat_iter242_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.4, max_hold: 40, risk: 0.3 }, params);
  }
