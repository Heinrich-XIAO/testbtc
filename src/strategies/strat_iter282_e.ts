...
export interface StratIter282EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter282EStrategy extends BaseIterStrategy<StratIter282EParams> {
  constructor(params: Partial<StratIter282EParams> = {}) {
    super('strat_iter282_e.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
