...
export interface StratIter274CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter274CStrategy extends BaseIterStrategy<StratIter274CParams> {
  constructor(params: Partial<StratIter274CParams> = {}) {
    super('strat_iter274_c.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
