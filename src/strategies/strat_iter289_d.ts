...
export interface StratIter289DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter289DStrategy extends BaseIterStrategy<StratIter289DParams> {
  constructor(params: Partial<StratIter289DParams> = {}) {
    super('strat_iter289_d.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
