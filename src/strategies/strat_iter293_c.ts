...
export interface StratIter293CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter293CStrategy extends BaseIterStrategy<StratIter293CParams> {
  constructor(params: Partial<StratIter293CParams> = {}) {
    super('strat_iter293_c.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
