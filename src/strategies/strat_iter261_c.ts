...
export interface StratIter261CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter261CStrategy extends BaseIterStrategy<StratIter261CParams> {
  constructor(params: Partial<StratIter261CParams> = {}) {
    super('strat_iter261_c.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
