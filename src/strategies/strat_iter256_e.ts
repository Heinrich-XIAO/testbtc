...
// 45% risk, 1.0% drop, 40% profit, 8% stop, 45 hold
...
export interface StratIter256EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter256EStrategy extends BaseIterStrategy<StratIter256EParams> {
  constructor(params: Partial<StratIter256EParams> = {}) {
    super('strat_iter256_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 45, risk: 0.45 }, params);
  }
