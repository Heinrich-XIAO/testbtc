...
// 35 bar hold, 40% profit, 8% stop, 40% risk, 3.0% drop
...
export interface StratIter244CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter244CStrategy extends BaseIterStrategy<StratIter244CParams> {
  constructor(params: Partial<StratIter244CParams> = {}) {
    super('strat_iter244_c.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.4 }, params);
  }
