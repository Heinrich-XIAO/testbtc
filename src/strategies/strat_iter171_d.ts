...
export interface StratIter171DParams extends StrategyParams {
  ma_period: number;
  stop_loss: number;
...
export class StratIter171DStrategy implements Strategy {
  params: StratIter171DParams;
  ...
  constructor(params: Partial<StratIter171DParams> = {}) {
    const saved = loadSavedParams<StratIter171DParams>('strat_iter171_d.params.json');
    this.params = {
      ma_period: 50,
      stop_loss: 0.08,
      profit_target: 0.16,
