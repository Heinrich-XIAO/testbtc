...
export interface StratIter210DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter210DStrategy extends BaseIterStrategy<StratIter210DParams> {
  constructor(params: Partial<StratIter210DParams> = {}) {
    super('strat_iter210_d.params.json', { drop_pct: 0.05, stop_loss: 0.12, profit_target: 0.30, max_hold: 25, risk: 0.25 }, params);
  }
