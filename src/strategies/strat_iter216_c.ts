...
// 40% profit, 8% stop, 30 hold, 40% risk
...
export interface StratIter216CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter216CStrategy extends BaseIterStrategy<StratIter216CParams> {
  constructor(params: Partial<StratIter216CParams> = {}) {
    super('strat_iter216_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 30, risk: 0.4 }, params);
  }
