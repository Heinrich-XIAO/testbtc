...
export interface StratIter231AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter231AStrategy extends BaseIterStrategy<StratIter231AParams> {
  constructor(params: Partial<StratIter231AParams> = {}) {
    super('strat_iter231_a.params.json', { drop_pct: 0.01, stop_loss: 0.12, trailing_stop: 0.05, max_hold: 25, risk: 0.3 }, params);
  }
