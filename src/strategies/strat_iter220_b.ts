...
// 50% profit, 12% stop, 40 hold, 35% risk
...
export interface StratIter220BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter220BStrategy extends BaseIterStrategy<StratIter220BParams> {
  constructor(params: Partial<StratIter220BParams> = {}) {
    super('strat_iter220_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.35 }, params);
  }
