...
// 50% profit, 10% stop, 35 hold, 45% risk
...
export interface StratIter218DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter218DStrategy extends BaseIterStrategy<StratIter218DParams> {
  constructor(params: Partial<StratIter218DParams> = {}) {
    super('strat_iter218_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.45 }, params);
  }
