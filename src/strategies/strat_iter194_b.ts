...
export interface StratIter194BParams extends StrategyParams { rsi_period: number; rsi_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter194BStrategy extends BaseIterStrategy<StratIter194BParams> {
  constructor(params: Partial<StratIter194BParams> = {}) { super('strat_iter194_b.params.json', { rsi_period: 14, rsi_oversold: 30, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
