...
export interface StratIter255BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter255BStrategy extends BaseIterStrategy<StratIter255BParams> {
  constructor(params: Partial<StratIter255BParams> = {}) {
    super('strat_iter255_b.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.45, max_hold: 35, risk: 0.8 }, params);
  }
