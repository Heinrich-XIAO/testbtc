...
// 1.0% drop, 40% profit, 8% stop, 40 hold
...
export interface StratIter224DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter224DStrategy extends BaseIterStrategy<StratIter224DParams> {
  constructor(params: Partial<StratIter224DParams> = {}) {
    super('strat_iter224_d.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 40, risk: 0.3 }, params);
  }
