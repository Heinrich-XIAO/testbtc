...
export interface StratIter271AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter271AStrategy extends BaseIterStrategy<StratIter271AParams> {
  constructor(params: Partial<StratIter271AParams> = {}) {
    super('strat_iter271_a.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
