...
export interface StratIter281CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter281CStrategy extends BaseIterStrategy<StratIter281CParams> {
  constructor(params: Partial<StratIter281CParams> = {}) {
    super('strat_iter281_c.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
