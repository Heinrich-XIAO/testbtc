...
// 50% profit, 10% stop, 35 hold, 40% risk
...
export interface StratIter218CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter218CStrategy extends BaseIterStrategy<StratIter218CParams> {
  constructor(params: Partial<StratIter218CParams> = {}) {
    super('strat_iter218_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.4 }, params);
  }
