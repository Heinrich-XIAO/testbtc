...
// 3.0% drop, 40% profit, 8% stop, 35 hold
...
export interface StratIter228CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter228CStrategy extends BaseIterStrategy<StratIter228CParams> {
  constructor(params: Partial<StratIter228CParams> = {}) {
    super('strat_iter228_c.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.3 }, params);
  }
