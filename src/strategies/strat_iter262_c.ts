...
export interface StratIter262CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter262CStrategy extends BaseIterStrategy<StratIter262CParams> {
  constructor(params: Partial<StratIter262CParams> = {}) {
    super('strat_iter262_c.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
