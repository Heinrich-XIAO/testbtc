...
export interface StratIter200CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter200CStrategy extends BaseIterStrategy<StratIter200CParams> {
  constructor(params: Partial<StratIter200CParams> = {}) { super('strat_iter200_c.params.json', { fast_period: 50, slow_period: 100, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
