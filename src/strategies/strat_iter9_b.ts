...
export interface StratIter9BParams extends StrategyParams {
...
const defaultParams: StratIter9BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter9BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter9_b.params.json');
...
export class StratIter9BStrategy implements Strategy {
  params: StratIter9BParams;
  ...
  constructor(params: Partial<StratIter9BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter9BParams;
  }
