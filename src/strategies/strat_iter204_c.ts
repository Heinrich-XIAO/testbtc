...
export interface StratIter204CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter204CStrategy extends BaseIterStrategy<StratIter204CParams> {
  constructor(params: Partial<StratIter204CParams> = {}) {
    super('strat_iter204_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
