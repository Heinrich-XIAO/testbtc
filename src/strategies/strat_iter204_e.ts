...
export interface StratIter204EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter204EStrategy extends BaseIterStrategy<StratIter204EParams> {
  constructor(params: Partial<StratIter204EParams> = {}) {
    super('strat_iter204_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 25, risk: 0.25 }, params);
  }
