...
// 75% risk, 2.5% drop, 50% profit, 12% stop, 35 hold
...
export interface StratIter259CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter259CStrategy extends BaseIterStrategy<StratIter259CParams> {
  constructor(params: Partial<StratIter259CParams> = {}) {
    super('strat_iter259_c.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 35, risk: 0.75 }, params);
  }
