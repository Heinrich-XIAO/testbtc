...
export interface StratIter263AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter263AStrategy extends BaseIterStrategy<StratIter263AParams> {
  constructor(params: Partial<StratIter263AParams> = {}) {
    super('strat_iter263_a.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
