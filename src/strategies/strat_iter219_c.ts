...
// 40% profit, 12% stop, 35 hold, 40% risk
...
export interface StratIter219CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter219CStrategy extends BaseIterStrategy<StratIter219CParams> {
  constructor(params: Partial<StratIter219CParams> = {}) {
    super('strat_iter219_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 35, risk: 0.4 }, params);
  }
