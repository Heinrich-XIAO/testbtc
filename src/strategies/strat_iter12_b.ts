...
export interface StratIter12BParams extends StrategyParams {
...
const defaultParams: StratIter12BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter12BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter12_b.params.json');
...
export class StratIter12BStrategy implements Strategy {
  params: StratIter12BParams;
  ...
  constructor(params: Partial<StratIter12BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter12BParams;
  }
