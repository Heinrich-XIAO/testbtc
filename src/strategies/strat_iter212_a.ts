...
// 40% profit target with 4% stop loss
...
export interface StratIter212AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter212AStrategy extends BaseIterStrategy<StratIter212AParams> {
  constructor(params: Partial<StratIter212AParams> = {}) {
    super('strat_iter212_a.params.json', { drop_pct: 0.02, stop_loss: 0.04, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
