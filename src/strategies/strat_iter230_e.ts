...
// 1.5% drop, 45% profit, 9% stop, 45 hold
...
export interface StratIter230EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter230EStrategy extends BaseIterStrategy<StratIter230EParams> {
  constructor(params: Partial<StratIter230EParams> = {}) {
    super('strat_iter230_e.params.json', { drop_pct: 0.015, stop_loss: 0.09, profit_target: 0.45, max_hold: 45, risk: 0.3 }, params);
  }
