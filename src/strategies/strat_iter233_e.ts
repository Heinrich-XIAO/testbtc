...
export interface StratIter233EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter233EStrategy extends BaseIterStrategy<StratIter233EParams> {
  constructor(params: Partial<StratIter233EParams> = {}) {
    super('strat_iter233_e.params.json', { drop_pct: 0.03, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 25, risk: 0.3 }, params);
  }
