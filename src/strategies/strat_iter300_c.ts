...
// Grid: 1.5% drop, 12% stop, 30% profit, 40 hold, 40% risk
...
export interface StratIter300CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter300CStrategy extends BaseIterStrategy<StratIter300CParams> {
  constructor(params: Partial<StratIter300CParams> = {}) {
    super('strat_iter300_c.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
