...
export interface StratIter194AParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter194AStrategy extends BaseIterStrategy<StratIter194AParams> {
  constructor(params: Partial<StratIter194AParams> = {}) { super('strat_iter194_a.params.json', { stoch_period: 14, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
