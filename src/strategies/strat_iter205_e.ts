...
export interface StratIter205EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter205EStrategy extends BaseIterStrategy<StratIter205EParams> {
  constructor(params: Partial<StratIter205EParams> = {}) {
    super('strat_iter205_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.50 }, params);
  }
