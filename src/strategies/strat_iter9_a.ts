...
export interface StratIter9AParams extends StrategyParams {
...
const defaultParams: StratIter9AParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 88,
...
function loadSavedParams(): Partial<StratIter9AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter9_a.params.json');
...
export class StratIter9AStrategy implements Strategy {
  params: StratIter9AParams;
  ...
  constructor(params: Partial<StratIter9AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter9AParams;
  }
