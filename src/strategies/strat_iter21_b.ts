...
export interface StratIter21BParams extends StrategyParams {
...
const defaultParams: StratIter21BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter21BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter21_b.params.json');
...
export class StratIter21BStrategy implements Strategy {
  params: StratIter21BParams;
  ...
  constructor(params: Partial<StratIter21BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter21BParams;
  }
