...
// 65% risk, 2.0% drop, 50% profit, 10% stop, 25 hold
...
export interface StratIter258AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter258AStrategy extends BaseIterStrategy<StratIter258AParams> {
  constructor(params: Partial<StratIter258AParams> = {}) {
    super('strat_iter258_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 25, risk: 0.65 }, params);
  }
