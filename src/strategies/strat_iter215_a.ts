...
// 35% profit, 8% stop, 30 hold, 30% risk
...
export interface StratIter215AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter215AStrategy extends BaseIterStrategy<StratIter215AParams> {
  constructor(params: Partial<StratIter215AParams> = {}) {
    super('strat_iter215_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 30, risk: 0.3 }, params);
  }
