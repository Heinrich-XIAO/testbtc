...
// 2% drop entry with 35% profit target
...
export interface StratIter222AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter222AStrategy extends BaseIterStrategy<StratIter222AParams> {
  constructor(params: Partial<StratIter222AParams> = {}) {
    super('strat_iter222_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
