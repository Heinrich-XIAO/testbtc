...
export interface StratIter271EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter271EStrategy extends BaseIterStrategy<StratIter271EParams> {
  constructor(params: Partial<StratIter271EParams> = {}) {
    super('strat_iter271_e.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
