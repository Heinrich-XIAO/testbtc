...
// 1.0% drop, 45% profit, 10% stop, 25 hold
...
export interface StratIter225AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter225AStrategy extends BaseIterStrategy<StratIter225AParams> {
  constructor(params: Partial<StratIter225AParams> = {}) {
    super('strat_iter225_a.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
