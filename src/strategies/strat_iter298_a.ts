...
// Grid: 2.0% drop, 12% stop, 40% profit, 20 hold, 40% risk
...
export interface StratIter298AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter298AStrategy extends BaseIterStrategy<StratIter298AParams> {
  constructor(params: Partial<StratIter298AParams> = {}) {
    super('strat_iter298_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
