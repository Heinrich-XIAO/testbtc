...
// 50% profit, 12% stop, 40 hold, 40% risk
...
export interface StratIter220CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter220CStrategy extends BaseIterStrategy<StratIter220CParams> {
  constructor(params: Partial<StratIter220CParams> = {}) {
    super('strat_iter220_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.4 }, params);
  }
