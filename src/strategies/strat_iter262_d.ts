...
export interface StratIter262DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter262DStrategy extends BaseIterStrategy<StratIter262DParams> {
  constructor(params: Partial<StratIter262DParams> = {}) {
    super('strat_iter262_d.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
