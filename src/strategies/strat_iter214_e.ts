...
// 50% profit target with 12% stop loss
...
export interface StratIter214EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter214EStrategy extends BaseIterStrategy<StratIter214EParams> {
  constructor(params: Partial<StratIter214EParams> = {}) {
    super('strat_iter214_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
