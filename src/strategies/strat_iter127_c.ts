...
export interface StratIter127CParams extends StrategyParams {
...
export class StratIter127CStrategy extends BaseIterStrategy<StratIter127CParams> {
  constructor(params: Partial<StratIter127CParams> = {}) {
    super('strat_iter127_c.params.json', {
      partial_profit: 0.10,
      partial_percent: 0.5,
      stop_loss: 0.08,
      profit_target: 0.18,
