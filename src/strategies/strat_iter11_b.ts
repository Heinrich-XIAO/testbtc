...
export interface StratIter11BParams extends StrategyParams {
...
const defaultParams: StratIter11BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter11BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter11_b.params.json');
...
export class StratIter11BStrategy implements Strategy {
  params: StratIter11BParams;
  ...
  constructor(params: Partial<StratIter11BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter11BParams;
  }
