...
export interface StratIter162CParams extends StrategyParams {
  sr_lookback: number;
  macd_fast: number;
  macd_slow: number;
...
export class StratIter162CStrategy extends BaseIterStrategy<StratIter162CParams> {
  ...
  constructor(params: Partial<StratIter162CParams> = {}) {
    super('strat_iter162_c.params.json', {
      sr_lookback: 50,
      macd_fast: 12,
      macd_slow: 26,
      stoch_k_period: 14,
