...
export interface StratIter284EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter284EStrategy extends BaseIterStrategy<StratIter284EParams> {
  constructor(params: Partial<StratIter284EParams> = {}) {
    super('strat_iter284_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
