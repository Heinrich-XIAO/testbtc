...
export interface StratIter161CParams extends StrategyParams {
  cci_period: number;
  cci_oversold: number;
  cci_tighten: number;
  sr_lookback: number;
...
export class StratIter161CStrategy extends BaseIterStrategy<StratIter161CParams> {
  constructor(params: Partial<StratIter161CParams> = {}) {
    super('strat_iter161_c.params.json', {
      cci_period: 14,
      cci_oversold: -100,
      cci_tighten: -80,
      sr_lookback: 50,
