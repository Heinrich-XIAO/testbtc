...
export interface StratIter283BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter283BStrategy extends BaseIterStrategy<StratIter283BParams> {
  constructor(params: Partial<StratIter283BParams> = {}) {
    super('strat_iter283_b.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
