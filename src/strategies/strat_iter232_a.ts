...
export interface StratIter232AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter232AStrategy extends BaseIterStrategy<StratIter232AParams> {
  constructor(params: Partial<StratIter232AParams> = {}) {
    super('strat_iter232_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, trailing_stop: 0.05, max_hold: 25, risk: 0.3 }, params);
  }
