...
export interface StratIter273EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter273EStrategy extends BaseIterStrategy<StratIter273EParams> {
  constructor(params: Partial<StratIter273EParams> = {}) {
    super('strat_iter273_e.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
