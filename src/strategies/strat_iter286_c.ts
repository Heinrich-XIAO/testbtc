...
export interface StratIter286CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter286CStrategy extends BaseIterStrategy<StratIter286CParams> {
  constructor(params: Partial<StratIter286CParams> = {}) {
    super('strat_iter286_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
