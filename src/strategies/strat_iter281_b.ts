...
export interface StratIter281BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter281BStrategy extends BaseIterStrategy<StratIter281BParams> {
  constructor(params: Partial<StratIter281BParams> = {}) {
    super('strat_iter281_b.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
