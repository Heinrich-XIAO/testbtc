...
export interface StratIter208DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter208DStrategy extends BaseIterStrategy<StratIter208DParams> {
  constructor(params: Partial<StratIter208DParams> = {}) {
    super('strat_iter208_d.params.json', { drop_pct: 0.02, stop_loss: 0.10, profit_target: 0.20, max_hold: 10, risk: 0.25 }, params);
  }
