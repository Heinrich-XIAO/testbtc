...
export interface StratIter171CParams extends StrategyParams {
...
export class StratIter171CStrategy implements Strategy {
  params: StratIter171CParams;
  ...
  constructor(params: Partial<StratIter171CParams> = {}) {
    const saved = loadSavedParams<StratIter171CParams>('strat_iter171_c.params.json');
    this.params = {
      fast_ma_period: 5,
      slow_ma_period: 20,
      stop_loss: 0.08,
