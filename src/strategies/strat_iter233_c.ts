...
export interface StratIter233CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter233CStrategy extends BaseIterStrategy<StratIter233CParams> {
  constructor(params: Partial<StratIter233CParams> = {}) {
    super('strat_iter233_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, trailing_stop: 0.15, max_hold: 25, risk: 0.3 }, params);
  }
