...
// 3.0% drop, 40% profit, 8% stop, 25 hold
...
export interface StratIter228AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter228AStrategy extends BaseIterStrategy<StratIter228AParams> {
  constructor(params: Partial<StratIter228AParams> = {}) {
    super('strat_iter228_a.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
