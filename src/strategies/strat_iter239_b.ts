...
// 3.0% drop, 10% trail, 8% stop, 25 hold, 30% risk
...
export interface StratIter239BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter239BStrategy extends BaseIterStrategy<StratIter239BParams> {
  constructor(params: Partial<StratIter239BParams> = {}) {
    super('strat_iter239_b.params.json', { drop_pct: 0.03, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 25, risk: 0.3 }, params);
  }
