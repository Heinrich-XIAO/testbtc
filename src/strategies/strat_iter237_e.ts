...
// 2.0% drop, 10% trail, 8% stop, 40 hold, 45% risk
...
export interface StratIter237EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter237EStrategy extends BaseIterStrategy<StratIter237EParams> {
  constructor(params: Partial<StratIter237EParams> = {}) {
    super('strat_iter237_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 40, risk: 0.45 }, params);
  }
