...
export interface StratIter279CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter279CStrategy extends BaseIterStrategy<StratIter279CParams> {
  constructor(params: Partial<StratIter279CParams> = {}) {
    super('strat_iter279_c.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
