...
export interface StratIter291EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter291EStrategy extends BaseIterStrategy<StratIter291EParams> {
  constructor(params: Partial<StratIter291EParams> = {}) {
    super('strat_iter291_e.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
