...
export interface StratIter27AParams extends StrategyParams {
...
const defaultParams: StratIter27AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter27AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter27_a.params.json');
...
export class StratIter27AStrategy implements Strategy {
  params: StratIter27AParams;
  ...
  constructor(params: Partial<StratIter27AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter27AParams;
  }
