...
// 1.0% drop, 10% trail, 8% stop, 40 hold, 45% risk
...
export interface StratIter235EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter235EStrategy extends BaseIterStrategy<StratIter235EParams> {
  constructor(params: Partial<StratIter235EParams> = {}) {
    super('strat_iter235_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 40, risk: 0.45 }, params);
  }
