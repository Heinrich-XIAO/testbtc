...
// Grid: 1.5% drop, 12% stop, 50% profit, 30 hold, 40% risk
...
export interface StratIter280CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter280CStrategy extends BaseIterStrategy<StratIter280CParams> {
  constructor(params: Partial<StratIter280CParams> = {}) {
    super('strat_iter280_c.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
