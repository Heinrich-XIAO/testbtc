...
export interface StratIter253AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter253AStrategy extends BaseIterStrategy<StratIter253AParams> {
  constructor(params: Partial<StratIter253AParams> = {}) {
    super('strat_iter253_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.4, max_hold: 30, risk: 0.6 }, params);
  }
