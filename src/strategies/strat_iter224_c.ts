...
// 1.0% drop, 40% profit, 8% stop, 35 hold
...
export interface StratIter224CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter224CStrategy extends BaseIterStrategy<StratIter224CParams> {
  constructor(params: Partial<StratIter224CParams> = {}) {
    super('strat_iter224_c.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.3 }, params);
  }
