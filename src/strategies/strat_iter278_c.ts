...
export interface StratIter278CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter278CStrategy extends BaseIterStrategy<StratIter278CParams> {
  constructor(params: Partial<StratIter278CParams> = {}) {
    super('strat_iter278_c.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
