...
// 60 bar hold, 40% profit, 12% stop, 30% risk, 2.0% drop
...
export interface StratIter248BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter248BStrategy extends BaseIterStrategy<StratIter248BParams> {
  constructor(params: Partial<StratIter248BParams> = {}) {
    super('strat_iter248_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 60, risk: 0.30000000000000004 }, params);
  }
