...
export interface StratIter186DParams extends StrategyParams { sr_lookback: number; entry_threshold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter186DStrategy extends BaseIterStrategy<StratIter186DParams> {
  constructor(params: Partial<StratIter186DParams> = {}) { super('strat_iter186_d.params.json', { sr_lookback: 50, entry_threshold: 0.02, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
