...
export interface StratIter242EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter242EStrategy extends BaseIterStrategy<StratIter242EParams> {
  constructor(params: Partial<StratIter242EParams> = {}) {
    super('strat_iter242_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 40, risk: 0.3 }, params);
  }
