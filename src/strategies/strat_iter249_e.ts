...
// 25 bar hold, 35% profit, 6% stop, 60% risk, 1.5% drop
...
export interface StratIter249EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter249EStrategy extends BaseIterStrategy<StratIter249EParams> {
  constructor(params: Partial<StratIter249EParams> = {}) {
    super('strat_iter249_e.params.json', { drop_pct: 0.015, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.6000000000000001 }, params);
  }
