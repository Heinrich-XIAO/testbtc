...
export interface StratIter201BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter201BStrategy extends BaseIterStrategy<StratIter201BParams> {
  constructor(params: Partial<StratIter201BParams> = {}) {
    super('strat_iter201_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
