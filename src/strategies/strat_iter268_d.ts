...
export interface StratIter268DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter268DStrategy extends BaseIterStrategy<StratIter268DParams> {
  constructor(params: Partial<StratIter268DParams> = {}) {
    super('strat_iter268_d.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
