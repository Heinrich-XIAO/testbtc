...
// 3% drop entry with 45% profit target
...
export interface StratIter223CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter223CStrategy extends BaseIterStrategy<StratIter223CParams> {
  constructor(params: Partial<StratIter223CParams> = {}) {
    super('strat_iter223_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
