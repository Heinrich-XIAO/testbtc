...
export interface StratIter268EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter268EStrategy extends BaseIterStrategy<StratIter268EParams> {
  constructor(params: Partial<StratIter268EParams> = {}) {
    super('strat_iter268_e.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
