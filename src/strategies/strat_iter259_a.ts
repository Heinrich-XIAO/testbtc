...
// 75% risk, 2.5% drop, 50% profit, 12% stop, 25 hold
...
export interface StratIter259AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter259AStrategy extends BaseIterStrategy<StratIter259AParams> {
  constructor(params: Partial<StratIter259AParams> = {}) {
    super('strat_iter259_a.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 25, risk: 0.75 }, params);
  }
