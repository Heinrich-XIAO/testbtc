...
// 55% risk, 1.5% drop, 45% profit, 10% stop, 45 hold
...
export interface StratIter257EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter257EStrategy extends BaseIterStrategy<StratIter257EParams> {
  constructor(params: Partial<StratIter257EParams> = {}) {
    super('strat_iter257_e.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.45, max_hold: 45, risk: 0.55 }, params);
  }
