...
// 3.0% drop, 10% trail, 8% stop, 20 hold, 25% risk
...
export interface StratIter239AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter239AStrategy extends BaseIterStrategy<StratIter239AParams> {
  constructor(params: Partial<StratIter239AParams> = {}) {
    super('strat_iter239_a.params.json', { drop_pct: 0.03, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 20, risk: 0.25 }, params);
  }
