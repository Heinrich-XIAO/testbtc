...
export interface SrStoch01Params extends StrategyParams {
...
const defaultParams: SrStoch01Params = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<SrStoch01Params> | null {
  const paramsPath = path.join(__dirname, 'strat_sr_stoch_01.params.json');
...
export class SrStoch01Strategy implements Strategy {
  params: SrStoch01Params;
  ...
  constructor(params: Partial<SrStoch01Params> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as SrStoch01Params;
  }
