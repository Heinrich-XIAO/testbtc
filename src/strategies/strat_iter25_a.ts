...
export interface StratIter25AParams extends StrategyParams {
...
const defaultParams: StratIter25AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 51,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter25AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter25_a.params.json');
...
export class StratIter25AStrategy implements Strategy {
  params: StratIter25AParams;
  ...
  constructor(params: Partial<StratIter25AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter25AParams;
  }
