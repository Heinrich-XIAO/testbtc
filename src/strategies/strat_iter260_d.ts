...
// 50% risk, 2.0% drop, 45% profit, 10% stop, 40 hold
...
export interface StratIter260DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter260DStrategy extends BaseIterStrategy<StratIter260DParams> {
  constructor(params: Partial<StratIter260DParams> = {}) {
    super('strat_iter260_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 40, risk: 0.5 }, params);
  }
