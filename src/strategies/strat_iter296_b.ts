...
export interface StratIter296BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter296BStrategy extends BaseIterStrategy<StratIter296BParams> {
  constructor(params: Partial<StratIter296BParams> = {}) {
    super('strat_iter296_b.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
