...
export interface StratIter283AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter283AStrategy extends BaseIterStrategy<StratIter283AParams> {
  constructor(params: Partial<StratIter283AParams> = {}) {
    super('strat_iter283_a.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
