...
export interface StratIter26CParams extends StrategyParams {
...
const defaultParams: StratIter26CParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter26CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter26_c.params.json');
...
export class StratIter26CStrategy implements Strategy {
  params: StratIter26CParams;
  ...
  constructor(params: Partial<StratIter26CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter26CParams;
  }
