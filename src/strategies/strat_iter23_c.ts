...
export interface StratIter23CParams extends StrategyParams {
...
const defaultParams: StratIter23CParams = {
  stoch_k_period: 18,
  stoch_d_period: 5,
  stoch_lookback: 52,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter23CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter23_c.params.json');
...
export class StratIter23CStrategy implements Strategy {
  params: StratIter23CParams;
  ...
  constructor(params: Partial<StratIter23CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter23CParams;
  }
