...
export interface StratIter276EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter276EStrategy extends BaseIterStrategy<StratIter276EParams> {
  constructor(params: Partial<StratIter276EParams> = {}) {
    super('strat_iter276_e.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
