...
export interface StratIter298BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter298BStrategy extends BaseIterStrategy<StratIter298BParams> {
  constructor(params: Partial<StratIter298BParams> = {}) {
    super('strat_iter298_b.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
