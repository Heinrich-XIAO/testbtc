...
export interface StratIter171AParams extends StrategyParams {
...
export class StratIter171AStrategy implements Strategy {
  params: StratIter171AParams;
  ...
  constructor(params: Partial<StratIter171AParams> = {}) {
    const saved = loadSavedParams<StratIter171AParams>('strat_iter171_a.params.json');
    this.params = {
      fast_ma_period: 50,
      slow_ma_period: 200,
      stop_loss: 0.08,
