...
// Grid: 2.0% drop, 12% stop, 30% profit, 40 hold, 40% risk
...
export interface StratIter278AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter278AStrategy extends BaseIterStrategy<StratIter278AParams> {
  constructor(params: Partial<StratIter278AParams> = {}) {
    super('strat_iter278_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
