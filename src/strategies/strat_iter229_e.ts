...
// 3.0% drop, 50% profit, 12% stop, 45 hold
...
export interface StratIter229EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter229EStrategy extends BaseIterStrategy<StratIter229EParams> {
  constructor(params: Partial<StratIter229EParams> = {}) {
    super('strat_iter229_e.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 45, risk: 0.3 }, params);
  }
