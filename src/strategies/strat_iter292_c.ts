...
export interface StratIter292CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter292CStrategy extends BaseIterStrategy<StratIter292CParams> {
  constructor(params: Partial<StratIter292CParams> = {}) {
    super('strat_iter292_c.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
