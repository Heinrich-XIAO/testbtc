...
export interface StratIter17CParams extends StrategyParams {
...
const defaultParams: StratIter17CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter17CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter17_c.params.json');
...
export class StratIter17CStrategy implements Strategy {
  params: StratIter17CParams;
  ...
  constructor(params: Partial<StratIter17CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter17CParams;
  }
