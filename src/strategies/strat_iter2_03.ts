...
export interface StratIter203Params extends StrategyParams {
...
const defaultParams: StratIter203Params = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter203Params> | null {
  const paramsPath = path.join(__dirname, 'strat_iter2_03.params.json');
...
export class StratIter203Strategy implements Strategy {
  params: StratIter203Params;
  ...
  constructor(params: Partial<StratIter203Params> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter203Params;
  }
