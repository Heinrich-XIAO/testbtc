...
export interface StratIter296DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter296DStrategy extends BaseIterStrategy<StratIter296DParams> {
  constructor(params: Partial<StratIter296DParams> = {}) {
    super('strat_iter296_d.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
