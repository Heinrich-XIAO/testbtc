...
// 1.5% drop, 45% profit, 9% stop, 30 hold
...
export interface StratIter230BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter230BStrategy extends BaseIterStrategy<StratIter230BParams> {
  constructor(params: Partial<StratIter230BParams> = {}) {
    super('strat_iter230_b.params.json', { drop_pct: 0.015, stop_loss: 0.09, profit_target: 0.45, max_hold: 30, risk: 0.3 }, params);
  }
