...
export interface StratIter232BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter232BStrategy extends BaseIterStrategy<StratIter232BParams> {
  constructor(params: Partial<StratIter232BParams> = {}) {
    super('strat_iter232_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, trailing_stop: 0.1, max_hold: 25, risk: 0.3 }, params);
  }
