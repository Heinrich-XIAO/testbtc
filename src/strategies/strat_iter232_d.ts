...
export interface StratIter232DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter232DStrategy extends BaseIterStrategy<StratIter232DParams> {
  constructor(params: Partial<StratIter232DParams> = {}) {
    super('strat_iter232_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, trailing_stop: 0.08, max_hold: 25, risk: 0.3 }, params);
  }
