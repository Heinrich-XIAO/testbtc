...
// Grid: 3.0% drop, 10% stop, 35% profit, 15 hold, 30% risk
...
export interface StratIter284BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter284BStrategy extends BaseIterStrategy<StratIter284BParams> {
  constructor(params: Partial<StratIter284BParams> = {}) {
    super('strat_iter284_b.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
