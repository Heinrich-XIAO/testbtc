...
export interface StratIter289BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter289BStrategy extends BaseIterStrategy<StratIter289BParams> {
  constructor(params: Partial<StratIter289BParams> = {}) {
    super('strat_iter289_b.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
