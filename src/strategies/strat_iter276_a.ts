...
export interface StratIter276AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter276AStrategy extends BaseIterStrategy<StratIter276AParams> {
  constructor(params: Partial<StratIter276AParams> = {}) {
    super('strat_iter276_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
