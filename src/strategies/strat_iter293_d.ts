...
export interface StratIter293DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter293DStrategy extends BaseIterStrategy<StratIter293DParams> {
  constructor(params: Partial<StratIter293DParams> = {}) {
    super('strat_iter293_d.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
