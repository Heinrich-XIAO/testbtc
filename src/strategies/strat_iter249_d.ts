...
// 25 bar hold, 35% profit, 6% stop, 50% risk, 2.0% drop
...
export interface StratIter249DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter249DStrategy extends BaseIterStrategy<StratIter249DParams> {
  constructor(params: Partial<StratIter249DParams> = {}) {
    super('strat_iter249_d.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.5 }, params);
  }
