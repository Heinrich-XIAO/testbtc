...
export interface StratIter27BParams extends StrategyParams {
...
const defaultParams: StratIter27BParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter27BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter27_b.params.json');
...
export class StratIter27BStrategy implements Strategy {
  params: StratIter27BParams;
  ...
  constructor(params: Partial<StratIter27BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter27BParams;
  }
