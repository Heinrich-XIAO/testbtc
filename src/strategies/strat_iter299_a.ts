...
// Grid: 2.5% drop, 15% stop, 45% profit, 25 hold, 50% risk
...
export interface StratIter299AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter299AStrategy extends BaseIterStrategy<StratIter299AParams> {
  constructor(params: Partial<StratIter299AParams> = {}) {
    super('strat_iter299_a.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
