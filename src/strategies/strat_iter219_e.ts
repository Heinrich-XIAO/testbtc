...
// 40% profit, 12% stop, 35 hold, 50% risk
...
export interface StratIter219EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter219EStrategy extends BaseIterStrategy<StratIter219EParams> {
  constructor(params: Partial<StratIter219EParams> = {}) {
    super('strat_iter219_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 35, risk: 0.5 }, params);
  }
