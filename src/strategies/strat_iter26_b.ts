...
export interface StratIter26BParams extends StrategyParams {
...
const defaultParams: StratIter26BParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter26BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter26_b.params.json');
...
export class StratIter26BStrategy implements Strategy {
  params: StratIter26BParams;
  ...
  constructor(params: Partial<StratIter26BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter26BParams;
  }
