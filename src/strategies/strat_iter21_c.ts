...
export interface StratIter21CParams extends StrategyParams {
...
const defaultParams: StratIter21CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter21CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter21_c.params.json');
...
export class StratIter21CStrategy implements Strategy {
  params: StratIter21CParams;
  ...
  constructor(params: Partial<StratIter21CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter21CParams;
  }
