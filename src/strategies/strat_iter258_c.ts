...
// 65% risk, 2.0% drop, 50% profit, 10% stop, 35 hold
...
export interface StratIter258CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter258CStrategy extends BaseIterStrategy<StratIter258CParams> {
  constructor(params: Partial<StratIter258CParams> = {}) {
    super('strat_iter258_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.65 }, params);
  }
