...
export interface StratIter207DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter207DStrategy extends BaseIterStrategy<StratIter207DParams> {
  constructor(params: Partial<StratIter207DParams> = {}) {
    super('strat_iter207_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.30, max_hold: 25, risk: 0.30 }, params);
  }
