...
export interface StratIter291AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter291AStrategy extends BaseIterStrategy<StratIter291AParams> {
  constructor(params: Partial<StratIter291AParams> = {}) {
    super('strat_iter291_a.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
