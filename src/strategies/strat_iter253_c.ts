...
export interface StratIter253CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter253CStrategy extends BaseIterStrategy<StratIter253CParams> {
  constructor(params: Partial<StratIter253CParams> = {}) {
    super('strat_iter253_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 35, risk: 0.6 }, params);
  }
