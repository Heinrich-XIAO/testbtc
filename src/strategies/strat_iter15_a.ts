...
export interface StratIter15AParams extends StrategyParams {
...
const defaultParams: StratIter15AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter15AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter15_a.params.json');
...
export class StratIter15AStrategy implements Strategy {
  params: StratIter15AParams;
  ...
  constructor(params: Partial<StratIter15AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter15AParams;
  }
