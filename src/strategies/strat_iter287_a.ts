...
export interface StratIter287AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter287AStrategy extends BaseIterStrategy<StratIter287AParams> {
  constructor(params: Partial<StratIter287AParams> = {}) {
    super('strat_iter287_a.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
