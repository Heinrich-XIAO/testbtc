...
export interface StratIter285AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter285AStrategy extends BaseIterStrategy<StratIter285AParams> {
  constructor(params: Partial<StratIter285AParams> = {}) {
    super('strat_iter285_a.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
