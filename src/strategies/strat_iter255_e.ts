...
export interface StratIter255EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter255EStrategy extends BaseIterStrategy<StratIter255EParams> {
  constructor(params: Partial<StratIter255EParams> = {}) {
    super('strat_iter255_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.8 }, params);
  }
