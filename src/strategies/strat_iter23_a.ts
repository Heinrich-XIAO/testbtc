...
export interface StratIter23AParams extends StrategyParams {
...
const defaultParams: StratIter23AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 52,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter23AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter23_a.params.json');
...
export class StratIter23AStrategy implements Strategy {
  params: StratIter23AParams;
  ...
  constructor(params: Partial<StratIter23AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter23AParams;
  }
