...
export interface StratIter191AParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter191AStrategy extends BaseIterStrategy<StratIter191AParams> {
  constructor(params: Partial<StratIter191AParams> = {}) { super('strat_iter191_a.params.json', { stoch_period: 30, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
