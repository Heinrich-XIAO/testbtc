...
export interface StratIter293AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter293AStrategy extends BaseIterStrategy<StratIter293AParams> {
  constructor(params: Partial<StratIter293AParams> = {}) {
    super('strat_iter293_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
