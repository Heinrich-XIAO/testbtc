...
export interface SrStoch03Params extends StrategyParams {
...
const defaultParams: SrStoch03Params = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<SrStoch03Params> | null {
  const paramsPath = path.join(__dirname, 'strat_sr_stoch_03.params.json');
...
export class SrStoch03Strategy implements Strategy {
  params: SrStoch03Params;
  ...
  constructor(params: Partial<SrStoch03Params> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as SrStoch03Params;
  }
