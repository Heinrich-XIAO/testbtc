...
export interface StratIter270BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter270BStrategy extends BaseIterStrategy<StratIter270BParams> {
  constructor(params: Partial<StratIter270BParams> = {}) {
    super('strat_iter270_b.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
