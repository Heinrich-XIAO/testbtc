...
export interface StratIter286DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter286DStrategy extends BaseIterStrategy<StratIter286DParams> {
  constructor(params: Partial<StratIter286DParams> = {}) {
    super('strat_iter286_d.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
