...
export interface StratIter6BParams extends StrategyParams {
...
const defaultParams: StratIter6BParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter6BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter6_b.params.json');
...
export class StratIter6BStrategy implements Strategy {
  params: StratIter6BParams;
  ...
  constructor(params: Partial<StratIter6BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter6BParams;
  }
