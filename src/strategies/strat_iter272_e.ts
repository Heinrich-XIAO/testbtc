...
// Grid: 1.0% drop, 8% stop, 50% profit, 30 hold, 20% risk
...
export interface StratIter272EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter272EStrategy extends BaseIterStrategy<StratIter272EParams> {
  constructor(params: Partial<StratIter272EParams> = {}) {
    super('strat_iter272_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
