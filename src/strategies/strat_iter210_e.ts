...
export interface StratIter210EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter210EStrategy extends BaseIterStrategy<StratIter210EParams> {
  constructor(params: Partial<StratIter210EParams> = {}) {
    super('strat_iter210_e.params.json', { drop_pct: 0.01, stop_loss: 0.06, profit_target: 0.18, max_hold: 15, risk: 0.50 }, params);
  }
