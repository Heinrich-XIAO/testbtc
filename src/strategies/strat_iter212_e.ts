...
// 40% profit target with 12% stop loss
...
export interface StratIter212EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter212EStrategy extends BaseIterStrategy<StratIter212EParams> {
  constructor(params: Partial<StratIter212EParams> = {}) {
    super('strat_iter212_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
