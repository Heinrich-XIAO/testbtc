...
// Grid: 2.0% drop, 10% stop, 45% profit, 25 hold, 30% risk
...
export interface StratIter292BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter292BStrategy extends BaseIterStrategy<StratIter292BParams> {
  constructor(params: Partial<StratIter292BParams> = {}) {
    super('strat_iter292_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
