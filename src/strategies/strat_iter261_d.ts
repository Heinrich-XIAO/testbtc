...
export interface StratIter261DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter261DStrategy extends BaseIterStrategy<StratIter261DParams> {
  constructor(params: Partial<StratIter261DParams> = {}) {
    super('strat_iter261_d.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
