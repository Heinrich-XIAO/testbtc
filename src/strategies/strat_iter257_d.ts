...
// 55% risk, 1.5% drop, 45% profit, 10% stop, 40 hold
...
export interface StratIter257DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter257DStrategy extends BaseIterStrategy<StratIter257DParams> {
  constructor(params: Partial<StratIter257DParams> = {}) {
    super('strat_iter257_d.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.45, max_hold: 40, risk: 0.55 }, params);
  }
