...
export interface StratIter24CParams extends StrategyParams {
...
const defaultParams: StratIter24CParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter24CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter24_c.params.json');
...
export class StratIter24CStrategy implements Strategy {
  params: StratIter24CParams;
  ...
  constructor(params: Partial<StratIter24CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter24CParams;
  }
