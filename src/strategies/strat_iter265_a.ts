...
// Grid: 3.0% drop, 10% stop, 25% profit, 35 hold, 30% risk
...
export interface StratIter265AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter265AStrategy extends BaseIterStrategy<StratIter265AParams> {
  constructor(params: Partial<StratIter265AParams> = {}) {
    super('strat_iter265_a.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
