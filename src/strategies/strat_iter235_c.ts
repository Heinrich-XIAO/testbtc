...
// 1.0% drop, 10% trail, 8% stop, 30 hold, 35% risk
...
export interface StratIter235CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter235CStrategy extends BaseIterStrategy<StratIter235CParams> {
  constructor(params: Partial<StratIter235CParams> = {}) {
    super('strat_iter235_c.params.json', { drop_pct: 0.01, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 30, risk: 0.35 }, params);
  }
