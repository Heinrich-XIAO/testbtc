...
// 75% risk, 2.5% drop, 50% profit, 12% stop, 45 hold
...
export interface StratIter259EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter259EStrategy extends BaseIterStrategy<StratIter259EParams> {
  constructor(params: Partial<StratIter259EParams> = {}) {
    super('strat_iter259_e.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 45, risk: 0.75 }, params);
  }
