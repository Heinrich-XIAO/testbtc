...
export interface StratIter286AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter286AStrategy extends BaseIterStrategy<StratIter286AParams> {
  constructor(params: Partial<StratIter286AParams> = {}) {
    super('strat_iter286_a.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
