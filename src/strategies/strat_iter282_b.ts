...
export interface StratIter282BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter282BStrategy extends BaseIterStrategy<StratIter282BParams> {
  constructor(params: Partial<StratIter282BParams> = {}) {
    super('strat_iter282_b.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
