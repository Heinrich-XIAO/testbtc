...
export interface StratIter275AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter275AStrategy extends BaseIterStrategy<StratIter275AParams> {
  constructor(params: Partial<StratIter275AParams> = {}) {
    super('strat_iter275_a.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
