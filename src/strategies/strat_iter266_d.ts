...
export interface StratIter266DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter266DStrategy extends BaseIterStrategy<StratIter266DParams> {
  constructor(params: Partial<StratIter266DParams> = {}) {
    super('strat_iter266_d.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
