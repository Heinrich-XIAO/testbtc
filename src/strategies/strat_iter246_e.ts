...
// 45 bar hold, 45% profit, 10% stop, 60% risk, 1.5% drop
...
export interface StratIter246EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter246EStrategy extends BaseIterStrategy<StratIter246EParams> {
  constructor(params: Partial<StratIter246EParams> = {}) {
    super('strat_iter246_e.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.45, max_hold: 45, risk: 0.6000000000000001 }, params);
  }
