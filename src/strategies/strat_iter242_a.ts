...
// 40 bar hold with 35% profit target
...
export interface StratIter242AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter242AStrategy extends BaseIterStrategy<StratIter242AParams> {
  constructor(params: Partial<StratIter242AParams> = {}) {
    super('strat_iter242_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 40, risk: 0.3 }, params);
  }
