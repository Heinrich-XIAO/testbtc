...
// 25 bar hold, 35% profit, 6% stop, 30% risk, 2.0% drop
...
export interface StratIter249BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter249BStrategy extends BaseIterStrategy<StratIter249BParams> {
  constructor(params: Partial<StratIter249BParams> = {}) {
    super('strat_iter249_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.30000000000000004 }, params);
  }
