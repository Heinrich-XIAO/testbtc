...
export interface StratIter8AParams extends StrategyParams {
...
const defaultParams: StratIter8AParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 88,
...
function loadSavedParams(): Partial<StratIter8AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter8_a.params.json');
...
export class StratIter8AStrategy implements Strategy {
  params: StratIter8AParams;
  ...
  constructor(params: Partial<StratIter8AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter8AParams;
  }
