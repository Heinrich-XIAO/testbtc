...
export interface StratIter280EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter280EStrategy extends BaseIterStrategy<StratIter280EParams> {
  constructor(params: Partial<StratIter280EParams> = {}) {
    super('strat_iter280_e.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
