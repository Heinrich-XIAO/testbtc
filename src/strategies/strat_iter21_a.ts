...
export interface StratIter21AParams extends StrategyParams {
...
const defaultParams: StratIter21AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter21AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter21_a.params.json');
...
export class StratIter21AStrategy implements Strategy {
  params: StratIter21AParams;
  ...
  constructor(params: Partial<StratIter21AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter21AParams;
  }
