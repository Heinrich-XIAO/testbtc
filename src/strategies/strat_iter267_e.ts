...
export interface StratIter267EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter267EStrategy extends BaseIterStrategy<StratIter267EParams> {
  constructor(params: Partial<StratIter267EParams> = {}) {
    super('strat_iter267_e.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
