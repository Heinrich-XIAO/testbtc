...
export interface StratIter264DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter264DStrategy extends BaseIterStrategy<StratIter264DParams> {
  constructor(params: Partial<StratIter264DParams> = {}) {
    super('strat_iter264_d.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
