...
export interface StratIter271CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter271CStrategy extends BaseIterStrategy<StratIter271CParams> {
  constructor(params: Partial<StratIter271CParams> = {}) {
    super('strat_iter271_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
