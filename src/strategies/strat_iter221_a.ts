...
// 1% drop entry with 35% profit target
...
export interface StratIter221AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter221AStrategy extends BaseIterStrategy<StratIter221AParams> {
  constructor(params: Partial<StratIter221AParams> = {}) {
    super('strat_iter221_a.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
