...
// 45 bar hold, 50% profit, 12% stop, 50% risk, 2.0% drop
...
export interface StratIter247DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter247DStrategy extends BaseIterStrategy<StratIter247DParams> {
  constructor(params: Partial<StratIter247DParams> = {}) {
    super('strat_iter247_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 45, risk: 0.5 }, params);
  }
