...
// Grid: 2.5% drop, 10% stop, 45% profit, 25 hold, 30% risk
...
export interface StratIter269AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter269AStrategy extends BaseIterStrategy<StratIter269AParams> {
  constructor(params: Partial<StratIter269AParams> = {}) {
    super('strat_iter269_a.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
