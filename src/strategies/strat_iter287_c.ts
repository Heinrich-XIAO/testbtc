...
export interface StratIter287CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter287CStrategy extends BaseIterStrategy<StratIter287CParams> {
  constructor(params: Partial<StratIter287CParams> = {}) {
    super('strat_iter287_c.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
