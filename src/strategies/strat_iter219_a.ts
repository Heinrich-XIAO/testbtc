...
// 40% profit, 12% stop, 35 hold, 30% risk
...
export interface StratIter219AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter219AStrategy extends BaseIterStrategy<StratIter219AParams> {
  constructor(params: Partial<StratIter219AParams> = {}) {
    super('strat_iter219_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 35, risk: 0.3 }, params);
  }
