...
// 35 bar hold, 50% profit, 10% stop, 20% risk, 1.0% drop
...
export interface StratIter245AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter245AStrategy extends BaseIterStrategy<StratIter245AParams> {
  constructor(params: Partial<StratIter245AParams> = {}) {
    super('strat_iter245_a.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.2 }, params);
  }
