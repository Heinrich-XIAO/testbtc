...
// 50 bar hold with 45% profit target
...
export interface StratIter243CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter243CStrategy extends BaseIterStrategy<StratIter243CParams> {
  constructor(params: Partial<StratIter243CParams> = {}) {
    super('strat_iter243_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 50, risk: 0.3 }, params);
  }
