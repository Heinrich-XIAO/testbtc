...
export interface StratIter277DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter277DStrategy extends BaseIterStrategy<StratIter277DParams> {
  constructor(params: Partial<StratIter277DParams> = {}) {
    super('strat_iter277_d.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
