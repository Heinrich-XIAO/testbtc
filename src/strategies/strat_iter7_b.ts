...
export interface StratIter7BParams extends StrategyParams {
...
const defaultParams: StratIter7BParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter7BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter7_b.params.json');
...
export class StratIter7BStrategy implements Strategy {
  params: StratIter7BParams;
  ...
  constructor(params: Partial<StratIter7BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter7BParams;
  }
