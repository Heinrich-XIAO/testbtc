...
// 1.0% drop, 10% trail, 8% stop, 20 hold, 25% risk
...
export interface StratIter235AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter235AStrategy extends BaseIterStrategy<StratIter235AParams> {
  constructor(params: Partial<StratIter235AParams> = {}) {
    super('strat_iter235_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 20, risk: 0.25 }, params);
  }
