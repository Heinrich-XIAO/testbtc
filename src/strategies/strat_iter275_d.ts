...
export interface StratIter275DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter275DStrategy extends BaseIterStrategy<StratIter275DParams> {
  constructor(params: Partial<StratIter275DParams> = {}) {
    super('strat_iter275_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
