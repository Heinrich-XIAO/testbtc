...
export interface StratIter206AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter206AStrategy extends BaseIterStrategy<StratIter206AParams> {
  constructor(params: Partial<StratIter206AParams> = {}) {
    super('strat_iter206_a.params.json', { drop_pct: 0.03, stop_loss: 0.04, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
