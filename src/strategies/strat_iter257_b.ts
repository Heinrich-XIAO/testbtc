...
// 55% risk, 1.5% drop, 45% profit, 10% stop, 30 hold
...
export interface StratIter257BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter257BStrategy extends BaseIterStrategy<StratIter257BParams> {
  constructor(params: Partial<StratIter257BParams> = {}) {
    super('strat_iter257_b.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.55 }, params);
  }
