...
export interface StratIter233DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter233DStrategy extends BaseIterStrategy<StratIter233DParams> {
  constructor(params: Partial<StratIter233DParams> = {}) {
    super('strat_iter233_d.params.json', { drop_pct: 0.03, stop_loss: 0.1, trailing_stop: 0.15, max_hold: 25, risk: 0.3 }, params);
  }
