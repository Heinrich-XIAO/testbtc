...
// Grid: 2.0% drop, 15% stop, 45% profit, 25 hold, 50% risk
...
export interface StratIter262BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter262BStrategy extends BaseIterStrategy<StratIter262BParams> {
  constructor(params: Partial<StratIter262BParams> = {}) {
    super('strat_iter262_b.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
