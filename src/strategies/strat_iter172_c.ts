...
export interface StratIter172CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter172CStrategy extends BaseIterStrategy<StratIter172CParams> {
  constructor(params: Partial<StratIter172CParams> = {}) { super('strat_iter172_c.params.json', { fast_period: 5, slow_period: 10, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
