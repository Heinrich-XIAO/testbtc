...
// 35 bar hold, 45% profit, 10% stop, 30% risk, 2.0% drop
...
export interface StratIter250BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter250BStrategy extends BaseIterStrategy<StratIter250BParams> {
  constructor(params: Partial<StratIter250BParams> = {}) {
    super('strat_iter250_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 35, risk: 0.30000000000000004 }, params);
  }
