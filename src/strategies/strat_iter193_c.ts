...
export interface StratIter193CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter193CStrategy extends BaseIterStrategy<StratIter193CParams> {
  constructor(params: Partial<StratIter193CParams> = {}) { super('strat_iter193_c.params.json', { fast_period: 10, slow_period: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
