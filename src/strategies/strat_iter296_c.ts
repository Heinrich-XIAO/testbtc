...
export interface StratIter296CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter296CStrategy extends BaseIterStrategy<StratIter296CParams> {
  constructor(params: Partial<StratIter296CParams> = {}) {
    super('strat_iter296_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
