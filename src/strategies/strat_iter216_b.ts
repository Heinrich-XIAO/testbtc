...
// 40% profit, 8% stop, 30 hold, 35% risk
...
export interface StratIter216BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter216BStrategy extends BaseIterStrategy<StratIter216BParams> {
  constructor(params: Partial<StratIter216BParams> = {}) {
    super('strat_iter216_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 30, risk: 0.35 }, params);
  }
