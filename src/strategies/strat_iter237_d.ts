...
// 2.0% drop, 10% trail, 8% stop, 35 hold, 40% risk
...
export interface StratIter237DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter237DStrategy extends BaseIterStrategy<StratIter237DParams> {
  constructor(params: Partial<StratIter237DParams> = {}) {
    super('strat_iter237_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 35, risk: 0.4 }, params);
  }
