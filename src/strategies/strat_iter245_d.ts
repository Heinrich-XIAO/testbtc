...
// 35 bar hold, 50% profit, 10% stop, 50% risk, 2.0% drop
...
export interface StratIter245DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter245DStrategy extends BaseIterStrategy<StratIter245DParams> {
  constructor(params: Partial<StratIter245DParams> = {}) {
    super('strat_iter245_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.5 }, params);
  }
