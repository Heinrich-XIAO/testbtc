...
// Grid: 1.5% drop, 10% stop, 35% profit, 15 hold, 30% risk
...
export interface StratIter297AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter297AStrategy extends BaseIterStrategy<StratIter297AParams> {
  constructor(params: Partial<StratIter297AParams> = {}) {
    super('strat_iter297_a.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
