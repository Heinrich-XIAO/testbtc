...
// 50% profit target with 6% stop loss
...
export interface StratIter214BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter214BStrategy extends BaseIterStrategy<StratIter214BParams> {
  constructor(params: Partial<StratIter214BParams> = {}) {
    super('strat_iter214_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
