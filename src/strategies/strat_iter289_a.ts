...
export interface StratIter289AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter289AStrategy extends BaseIterStrategy<StratIter289AParams> {
  constructor(params: Partial<StratIter289AParams> = {}) {
    super('strat_iter289_a.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
