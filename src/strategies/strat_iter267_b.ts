...
export interface StratIter267BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter267BStrategy extends BaseIterStrategy<StratIter267BParams> {
  constructor(params: Partial<StratIter267BParams> = {}) {
    super('strat_iter267_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
