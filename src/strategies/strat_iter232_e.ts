...
export interface StratIter232EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter232EStrategy extends BaseIterStrategy<StratIter232EParams> {
  constructor(params: Partial<StratIter232EParams> = {}) {
    super('strat_iter232_e.params.json', { drop_pct: 0.02, stop_loss: 0.06, trailing_stop: 0.12, max_hold: 30, risk: 0.3 }, params);
  }
