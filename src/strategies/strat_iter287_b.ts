...
export interface StratIter287BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter287BStrategy extends BaseIterStrategy<StratIter287BParams> {
  constructor(params: Partial<StratIter287BParams> = {}) {
    super('strat_iter287_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
