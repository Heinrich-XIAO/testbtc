...
export interface StratIter223EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter223EStrategy extends BaseIterStrategy<StratIter223EParams> {
  constructor(params: Partial<StratIter223EParams> = {}) {
    super('strat_iter223_e.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 35, risk: 0.3 }, params);
  }
