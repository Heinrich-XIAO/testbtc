...
// 3% drop entry with 40% profit target
...
export interface StratIter223BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter223BStrategy extends BaseIterStrategy<StratIter223BParams> {
  constructor(params: Partial<StratIter223BParams> = {}) {
    super('strat_iter223_b.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
