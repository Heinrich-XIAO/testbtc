...
// Grid: 1.0% drop, 10% stop, 35% profit, 15 hold, 30% risk
...
export interface StratIter261AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter261AStrategy extends BaseIterStrategy<StratIter261AParams> {
  constructor(params: Partial<StratIter261AParams> = {}) {
    super('strat_iter261_a.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
