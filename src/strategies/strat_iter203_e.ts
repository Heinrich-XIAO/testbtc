...
export interface StratIter203EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter203EStrategy extends BaseIterStrategy<StratIter203EParams> {
  constructor(params: Partial<StratIter203EParams> = {}) {
    super('strat_iter203_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.30, max_hold: 15, risk: 0.25 }, params);
  }
