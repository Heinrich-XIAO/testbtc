...
// Grid: 1.0% drop, 15% stop, 35% profit, 15 hold, 50% risk
...
export interface StratIter290BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter290BStrategy extends BaseIterStrategy<StratIter290BParams> {
  constructor(params: Partial<StratIter290BParams> = {}) {
    super('strat_iter290_b.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
