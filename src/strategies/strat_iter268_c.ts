...
export interface StratIter268CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter268CStrategy extends BaseIterStrategy<StratIter268CParams> {
  constructor(params: Partial<StratIter268CParams> = {}) {
    super('strat_iter268_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
