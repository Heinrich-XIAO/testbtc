...
// Grid: 3.0% drop, 12% stop, 30% profit, 40 hold, 40% risk
...
export interface StratIter286EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter286EStrategy extends BaseIterStrategy<StratIter286EParams> {
  constructor(params: Partial<StratIter286EParams> = {}) {
    super('strat_iter286_e.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
