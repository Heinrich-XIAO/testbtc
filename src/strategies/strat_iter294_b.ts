...
export interface StratIter294BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter294BStrategy extends BaseIterStrategy<StratIter294BParams> {
  constructor(params: Partial<StratIter294BParams> = {}) {
    super('strat_iter294_b.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
