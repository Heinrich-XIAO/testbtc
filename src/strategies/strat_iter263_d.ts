...
export interface StratIter263DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter263DStrategy extends BaseIterStrategy<StratIter263DParams> {
  constructor(params: Partial<StratIter263DParams> = {}) {
    super('strat_iter263_d.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
