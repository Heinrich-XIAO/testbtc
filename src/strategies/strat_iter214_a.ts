...
// 50% profit target with 4% stop loss
...
export interface StratIter214AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter214AStrategy extends BaseIterStrategy<StratIter214AParams> {
  constructor(params: Partial<StratIter214AParams> = {}) {
    super('strat_iter214_a.params.json', { drop_pct: 0.02, stop_loss: 0.04, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
