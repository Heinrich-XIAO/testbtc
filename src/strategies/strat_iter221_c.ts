...
// 1% drop entry with 45% profit target
...
export interface StratIter221CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter221CStrategy extends BaseIterStrategy<StratIter221CParams> {
  constructor(params: Partial<StratIter221CParams> = {}) {
    super('strat_iter221_c.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
