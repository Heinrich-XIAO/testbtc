...
export interface StratIter251EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter251EStrategy extends BaseIterStrategy<StratIter251EParams> {
  constructor(params: Partial<StratIter251EParams> = {}) {
    super('strat_iter251_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.45, max_hold: 35, risk: 0.4 }, params);
  }
