...
export interface StratIter204DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter204DStrategy extends BaseIterStrategy<StratIter204DParams> {
  constructor(params: Partial<StratIter204DParams> = {}) {
    super('strat_iter204_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 20, risk: 0.25 }, params);
  }
