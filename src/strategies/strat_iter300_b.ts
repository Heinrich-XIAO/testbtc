...
export interface StratIter300BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter300BStrategy extends BaseIterStrategy<StratIter300BParams> {
  constructor(params: Partial<StratIter300BParams> = {}) {
    super('strat_iter300_b.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
