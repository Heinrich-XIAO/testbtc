...
// 1% drop entry with 40% profit target
...
export interface StratIter221BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter221BStrategy extends BaseIterStrategy<StratIter221BParams> {
  constructor(params: Partial<StratIter221BParams> = {}) {
    super('strat_iter221_b.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
