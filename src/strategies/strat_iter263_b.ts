...
// Grid: 2.5% drop, 8% stop, 50% profit, 30 hold, 20% risk
...
export interface StratIter263BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter263BStrategy extends BaseIterStrategy<StratIter263BParams> {
  constructor(params: Partial<StratIter263BParams> = {}) {
    super('strat_iter263_b.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
