...
// 45% profit target with 10% stop loss
...
export interface StratIter213DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter213DStrategy extends BaseIterStrategy<StratIter213DParams> {
  constructor(params: Partial<StratIter213DParams> = {}) {
    super('strat_iter213_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
