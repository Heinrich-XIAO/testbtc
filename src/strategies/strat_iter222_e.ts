...
// 2% drop entry with 40% profit target
...
export interface StratIter222EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter222EStrategy extends BaseIterStrategy<StratIter222EParams> {
  constructor(params: Partial<StratIter222EParams> = {}) {
    super('strat_iter222_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
