...
// 35 bar hold, 45% profit, 10% stop, 20% risk, 1.0% drop
...
export interface StratIter250AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter250AStrategy extends BaseIterStrategy<StratIter250AParams> {
  constructor(params: Partial<StratIter250AParams> = {}) {
    super('strat_iter250_a.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 35, risk: 0.2 }, params);
  }
