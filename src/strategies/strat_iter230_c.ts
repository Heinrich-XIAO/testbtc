...
// 1.5% drop, 45% profit, 9% stop, 35 hold
...
export interface StratIter230CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter230CStrategy extends BaseIterStrategy<StratIter230CParams> {
  constructor(params: Partial<StratIter230CParams> = {}) {
    super('strat_iter230_c.params.json', { drop_pct: 0.015, stop_loss: 0.09, profit_target: 0.45, max_hold: 35, risk: 0.3 }, params);
  }
