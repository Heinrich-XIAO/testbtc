...
export interface StratIter255CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter255CStrategy extends BaseIterStrategy<StratIter255CParams> {
  constructor(params: Partial<StratIter255CParams> = {}) {
    super('strat_iter255_c.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.5, max_hold: 40, risk: 0.8 }, params);
  }
