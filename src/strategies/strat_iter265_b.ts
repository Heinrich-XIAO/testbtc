...
export interface StratIter265BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter265BStrategy extends BaseIterStrategy<StratIter265BParams> {
  constructor(params: Partial<StratIter265BParams> = {}) {
    super('strat_iter265_b.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
