...
export interface StratIter14CParams extends StrategyParams {
...
const defaultParams: StratIter14CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter14CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter14_c.params.json');
...
export class StratIter14CStrategy implements Strategy {
  params: StratIter14CParams;
  ...
  constructor(params: Partial<StratIter14CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter14CParams;
  }
