...
// Grid: 2.5% drop, 12% stop, 40% profit, 20 hold, 40% risk
...
export interface StratIter272CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter272CStrategy extends BaseIterStrategy<StratIter272CParams> {
  constructor(params: Partial<StratIter272CParams> = {}) {
    super('strat_iter272_c.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
