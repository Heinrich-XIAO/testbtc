...
export interface StratIter27CParams extends StrategyParams {
...
const defaultParams: StratIter27CParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter27CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter27_c.params.json');
...
export class StratIter27CStrategy implements Strategy {
  params: StratIter27CParams;
  ...
  constructor(params: Partial<StratIter27CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter27CParams;
  }
