...
export interface StratIter295EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter295EStrategy extends BaseIterStrategy<StratIter295EParams> {
  constructor(params: Partial<StratIter295EParams> = {}) {
    super('strat_iter295_e.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
