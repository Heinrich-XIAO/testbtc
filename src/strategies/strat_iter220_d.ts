...
// 50% profit, 12% stop, 40 hold, 45% risk
...
export interface StratIter220DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter220DStrategy extends BaseIterStrategy<StratIter220DParams> {
  constructor(params: Partial<StratIter220DParams> = {}) {
    super('strat_iter220_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.45 }, params);
  }
