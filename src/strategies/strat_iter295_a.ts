...
// Grid: 3.0% drop, 15% stop, 25% profit, 35 hold, 50% risk
...
export interface StratIter295AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter295AStrategy extends BaseIterStrategy<StratIter295AParams> {
  constructor(params: Partial<StratIter295AParams> = {}) {
    super('strat_iter295_a.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
