...
export interface StratIter275EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter275EStrategy extends BaseIterStrategy<StratIter275EParams> {
  constructor(params: Partial<StratIter275EParams> = {}) {
    super('strat_iter275_e.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
