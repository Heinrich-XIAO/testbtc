...
export interface StratIter17AParams extends StrategyParams {
...
const defaultParams: StratIter17AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter17AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter17_a.params.json');
...
export class StratIter17AStrategy implements Strategy {
  params: StratIter17AParams;
  ...
  constructor(params: Partial<StratIter17AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter17AParams;
  }
