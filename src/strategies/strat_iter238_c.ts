...
// 2.0% drop, 15% trail, 10% stop, 30 hold, 35% risk
...
export interface StratIter238CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter238CStrategy extends BaseIterStrategy<StratIter238CParams> {
  constructor(params: Partial<StratIter238CParams> = {}) {
    super('strat_iter238_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, trailing_stop: 0.15, max_hold: 30, risk: 0.35 }, params);
  }
