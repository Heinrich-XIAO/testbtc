...
export interface StratIter273DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter273DStrategy extends BaseIterStrategy<StratIter273DParams> {
  constructor(params: Partial<StratIter273DParams> = {}) {
    super('strat_iter273_d.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
