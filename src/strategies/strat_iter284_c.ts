...
export interface StratIter284CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter284CStrategy extends BaseIterStrategy<StratIter284CParams> {
  constructor(params: Partial<StratIter284CParams> = {}) {
    super('strat_iter284_c.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
