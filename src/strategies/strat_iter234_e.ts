...
// 1.0% drop, 5% trail, 6% stop, 40 hold, 45% risk
...
export interface StratIter234EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter234EStrategy extends BaseIterStrategy<StratIter234EParams> {
  constructor(params: Partial<StratIter234EParams> = {}) {
    super('strat_iter234_e.params.json', { drop_pct: 0.01, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 40, risk: 0.45 }, params);
  }
