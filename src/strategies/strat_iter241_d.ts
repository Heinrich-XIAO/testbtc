...
// 30 bar hold with 50% profit target
...
export interface StratIter241DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter241DStrategy extends BaseIterStrategy<StratIter241DParams> {
  constructor(params: Partial<StratIter241DParams> = {}) {
    super('strat_iter241_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.3 }, params);
  }
