...
// 1% drop entry with 50% profit target
...
export interface StratIter221DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter221DStrategy extends BaseIterStrategy<StratIter221DParams> {
  constructor(params: Partial<StratIter221DParams> = {}) {
    super('strat_iter221_d.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
