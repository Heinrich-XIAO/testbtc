...
export interface StratIter298CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter298CStrategy extends BaseIterStrategy<StratIter298CParams> {
  constructor(params: Partial<StratIter298CParams> = {}) {
    super('strat_iter298_c.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
