...
export interface StratIter208AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter208AStrategy extends BaseIterStrategy<StratIter208AParams> {
  constructor(params: Partial<StratIter208AParams> = {}) {
    super('strat_iter208_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.25, max_hold: 5, risk: 0.25 }, params);
  }
