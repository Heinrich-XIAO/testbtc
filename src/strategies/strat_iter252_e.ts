...
export interface StratIter252EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter252EStrategy extends BaseIterStrategy<StratIter252EParams> {
  constructor(params: Partial<StratIter252EParams> = {}) {
    super('strat_iter252_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.5 }, params);
  }
