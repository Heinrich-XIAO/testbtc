...
// 2.0% drop, 35% profit, 6% stop, 35 hold
...
export interface StratIter226CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter226CStrategy extends BaseIterStrategy<StratIter226CParams> {
  constructor(params: Partial<StratIter226CParams> = {}) {
    super('strat_iter226_c.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 35, risk: 0.3 }, params);
  }
