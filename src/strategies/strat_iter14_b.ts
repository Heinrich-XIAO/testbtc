...
export interface StratIter14BParams extends StrategyParams {
...
const defaultParams: StratIter14BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter14BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter14_b.params.json');
...
export class StratIter14BStrategy implements Strategy {
  params: StratIter14BParams;
  ...
  constructor(params: Partial<StratIter14BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter14BParams;
  }
