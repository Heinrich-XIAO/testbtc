...
export interface StratIter207CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter207CStrategy extends BaseIterStrategy<StratIter207CParams> {
  constructor(params: Partial<StratIter207CParams> = {}) {
    super('strat_iter207_c.params.json', { drop_pct: 0.02, stop_loss: 0.10, profit_target: 0.25, max_hold: 20, risk: 0.25 }, params);
  }
