...
// Grid: 1.5% drop, 12% stop, 40% profit, 20 hold, 40% risk
...
export interface StratIter261BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter261BStrategy extends BaseIterStrategy<StratIter261BParams> {
  constructor(params: Partial<StratIter261BParams> = {}) {
    super('strat_iter261_b.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
