...
// Grid: 1.5% drop, 8% stop, 30% profit, 40 hold, 20% risk
...
export interface StratIter269DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter269DStrategy extends BaseIterStrategy<StratIter269DParams> {
  constructor(params: Partial<StratIter269DParams> = {}) {
    super('strat_iter269_d.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
