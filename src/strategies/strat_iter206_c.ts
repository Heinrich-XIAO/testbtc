...
export interface StratIter206CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter206CStrategy extends BaseIterStrategy<StratIter206CParams> {
  constructor(params: Partial<StratIter206CParams> = {}) {
    super('strat_iter206_c.params.json', { drop_pct: 0.05, stop_loss: 0.06, profit_target: 0.25, max_hold: 20, risk: 0.25 }, params);
  }
