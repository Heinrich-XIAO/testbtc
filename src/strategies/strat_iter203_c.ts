...
export interface StratIter203CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter203CStrategy extends BaseIterStrategy<StratIter203CParams> {
  constructor(params: Partial<StratIter203CParams> = {}) {
    super('strat_iter203_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.20, max_hold: 15, risk: 0.25 }, params);
  }
