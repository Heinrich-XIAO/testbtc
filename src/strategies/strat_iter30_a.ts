...
export interface StratIter30AParams extends StrategyParams {
...
const defaultParams: StratIter30AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter30AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter30_a.params.json');
...
export class StratIter30AStrategy implements Strategy {
  params: StratIter30AParams;
  ...
  constructor(params: Partial<StratIter30AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter30AParams;
  }
