...
export interface StratIter279DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter279DStrategy extends BaseIterStrategy<StratIter279DParams> {
  constructor(params: Partial<StratIter279DParams> = {}) {
    super('strat_iter279_d.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
