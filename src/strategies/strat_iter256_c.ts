...
// 45% risk, 1.0% drop, 40% profit, 8% stop, 35 hold
...
export interface StratIter256CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter256CStrategy extends BaseIterStrategy<StratIter256CParams> {
  constructor(params: Partial<StratIter256CParams> = {}) {
    super('strat_iter256_c.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.45 }, params);
  }
