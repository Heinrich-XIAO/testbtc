...
// 50% risk, 2.0% drop, 45% profit, 10% stop, 35 hold
...
export interface StratIter260CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter260CStrategy extends BaseIterStrategy<StratIter260CParams> {
  constructor(params: Partial<StratIter260CParams> = {}) {
    super('strat_iter260_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 35, risk: 0.5 }, params);
  }
