...
export interface StratIter290DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter290DStrategy extends BaseIterStrategy<StratIter290DParams> {
  constructor(params: Partial<StratIter290DParams> = {}) {
    super('strat_iter290_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
