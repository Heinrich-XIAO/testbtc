...
// Grid: 2.5% drop, 8% stop, 40% profit, 20 hold, 20% risk
...
export interface StratIter300EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter300EStrategy extends BaseIterStrategy<StratIter300EParams> {
  constructor(params: Partial<StratIter300EParams> = {}) {
    super('strat_iter300_e.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
