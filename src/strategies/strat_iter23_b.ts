...
export interface StratIter23BParams extends StrategyParams {
...
const defaultParams: StratIter23BParams = {
  stoch_k_period: 10,
  stoch_d_period: 3,
  stoch_lookback: 52,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter23BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter23_b.params.json');
...
export class StratIter23BStrategy implements Strategy {
  params: StratIter23BParams;
  ...
  constructor(params: Partial<StratIter23BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter23BParams;
  }
