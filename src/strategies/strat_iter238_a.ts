...
// 2.0% drop, 15% trail, 10% stop, 20 hold, 25% risk
...
export interface StratIter238AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter238AStrategy extends BaseIterStrategy<StratIter238AParams> {
  constructor(params: Partial<StratIter238AParams> = {}) {
    super('strat_iter238_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, trailing_stop: 0.15, max_hold: 20, risk: 0.25 }, params);
  }
