...
// 2.0% drop, 10% trail, 8% stop, 20 hold, 25% risk
...
export interface StratIter237AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter237AStrategy extends BaseIterStrategy<StratIter237AParams> {
  constructor(params: Partial<StratIter237AParams> = {}) {
    super('strat_iter237_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 20, risk: 0.25 }, params);
  }
