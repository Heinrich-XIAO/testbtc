...
export interface StratIter205AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter205AStrategy extends BaseIterStrategy<StratIter205AParams> {
  constructor(params: Partial<StratIter205AParams> = {}) {
    super('strat_iter205_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.10 }, params);
  }
