...
// 45% profit target with 4% stop loss
...
export interface StratIter213AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter213AStrategy extends BaseIterStrategy<StratIter213AParams> {
  constructor(params: Partial<StratIter213AParams> = {}) {
    super('strat_iter213_a.params.json', { drop_pct: 0.02, stop_loss: 0.04, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
