...
export interface StratIter281EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter281EStrategy extends BaseIterStrategy<StratIter281EParams> {
  constructor(params: Partial<StratIter281EParams> = {}) {
    super('strat_iter281_e.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
