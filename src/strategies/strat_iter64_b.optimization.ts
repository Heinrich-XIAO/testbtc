...
export const optimizationConfig = {
  te_lookback: { min: 25, max: 55, stepSize: 5 },
  te_bins: { min: 3, max: 6, stepSize: 1 },
  te_lag: { min: 2, max: 5, stepSize: 1 },
  te_threshold: { min: 0.04, max: 0.15, stepSize: 0.02 },
  te_direction: { min: 0, max: 1, stepSize: 1 },
...
export const outputFile = 'strat_iter64_b.params.json';
