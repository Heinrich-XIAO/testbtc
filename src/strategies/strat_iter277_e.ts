...
export interface StratIter277EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter277EStrategy extends BaseIterStrategy<StratIter277EParams> {
  constructor(params: Partial<StratIter277EParams> = {}) {
    super('strat_iter277_e.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
