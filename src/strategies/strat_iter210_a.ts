...
export interface StratIter210AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter210AStrategy extends BaseIterStrategy<StratIter210AParams> {
  constructor(params: Partial<StratIter210AParams> = {}) {
    super('strat_iter210_a.params.json', { drop_pct: 0.02, stop_loss: 0.04, profit_target: 0.20, max_hold: 20, risk: 0.40 }, params);
  }
