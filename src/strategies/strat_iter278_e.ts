...
export interface StratIter278EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter278EStrategy extends BaseIterStrategy<StratIter278EParams> {
  constructor(params: Partial<StratIter278EParams> = {}) {
    super('strat_iter278_e.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
