...
export interface StratIter207EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter207EStrategy extends BaseIterStrategy<StratIter207EParams> {
  constructor(params: Partial<StratIter207EParams> = {}) {
    super('strat_iter207_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.40 }, params);
  }
