...
export interface StratIter272BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter272BStrategy extends BaseIterStrategy<StratIter272BParams> {
  constructor(params: Partial<StratIter272BParams> = {}) {
    super('strat_iter272_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
