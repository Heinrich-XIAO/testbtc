...
export interface StratIter201EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter201EStrategy extends BaseIterStrategy<StratIter201EParams> {
  constructor(params: Partial<StratIter201EParams> = {}) {
    super('strat_iter201_e.params.json', { drop_pct: 0.05, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
