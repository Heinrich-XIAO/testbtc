...
export interface StratIter252CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter252CStrategy extends BaseIterStrategy<StratIter252CParams> {
  constructor(params: Partial<StratIter252CParams> = {}) {
    super('strat_iter252_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 30, risk: 0.5 }, params);
  }
