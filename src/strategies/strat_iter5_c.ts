...
export interface StratIter5CParams extends StrategyParams {
...
const defaultParams: StratIter5CParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter5CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter5_c.params.json');
...
export class StratIter5CStrategy implements Strategy {
  params: StratIter5CParams;
  ...
  constructor(params: Partial<StratIter5CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter5CParams;
  }
