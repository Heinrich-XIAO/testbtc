...
// 45% profit target with 8% stop loss
...
export interface StratIter213CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter213CStrategy extends BaseIterStrategy<StratIter213CParams> {
  constructor(params: Partial<StratIter213CParams> = {}) {
    super('strat_iter213_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
