...
// 1.5% drop, 8% trail, 8% stop, 35 hold, 40% risk
...
export interface StratIter240DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter240DStrategy extends BaseIterStrategy<StratIter240DParams> {
  constructor(params: Partial<StratIter240DParams> = {}) {
    super('strat_iter240_d.params.json', { drop_pct: 0.015, stop_loss: 0.08, trailing_stop: 0.08, max_hold: 35, risk: 0.4 }, params);
  }
