...
// 1.0% drop, 45% profit, 10% stop, 40 hold
...
export interface StratIter225DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter225DStrategy extends BaseIterStrategy<StratIter225DParams> {
  constructor(params: Partial<StratIter225DParams> = {}) {
    super('strat_iter225_d.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 40, risk: 0.3 }, params);
  }
