...
export interface StratIter264BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter264BStrategy extends BaseIterStrategy<StratIter264BParams> {
  constructor(params: Partial<StratIter264BParams> = {}) {
    super('strat_iter264_b.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
