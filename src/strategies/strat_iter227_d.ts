...
// 2.0% drop, 50% profit, 10% stop, 40 hold
...
export interface StratIter227DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter227DStrategy extends BaseIterStrategy<StratIter227DParams> {
  constructor(params: Partial<StratIter227DParams> = {}) {
    super('strat_iter227_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 40, risk: 0.3 }, params);
  }
