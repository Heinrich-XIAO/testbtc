...
export interface StratIter287DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter287DStrategy extends BaseIterStrategy<StratIter287DParams> {
  constructor(params: Partial<StratIter287DParams> = {}) {
    super('strat_iter287_d.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
