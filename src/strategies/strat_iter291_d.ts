...
export interface StratIter291DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter291DStrategy extends BaseIterStrategy<StratIter291DParams> {
  constructor(params: Partial<StratIter291DParams> = {}) {
    super('strat_iter291_d.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
