...
export interface StratIter288DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter288DStrategy extends BaseIterStrategy<StratIter288DParams> {
  constructor(params: Partial<StratIter288DParams> = {}) {
    super('strat_iter288_d.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
