...
// 50% profit target with 8% stop loss
...
export interface StratIter214CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter214CStrategy extends BaseIterStrategy<StratIter214CParams> {
  constructor(params: Partial<StratIter214CParams> = {}) {
    super('strat_iter214_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
