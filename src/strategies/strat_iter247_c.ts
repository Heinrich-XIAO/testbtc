...
// 45 bar hold, 50% profit, 12% stop, 40% risk, 3.0% drop
...
export interface StratIter247CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter247CStrategy extends BaseIterStrategy<StratIter247CParams> {
  constructor(params: Partial<StratIter247CParams> = {}) {
    super('strat_iter247_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 45, risk: 0.4 }, params);
  }
