...
export interface StratIter15BParams extends StrategyParams {
...
const defaultParams: StratIter15BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter15BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter15_b.params.json');
...
export class StratIter15BStrategy implements Strategy {
  params: StratIter15BParams;
  ...
  constructor(params: Partial<StratIter15BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter15BParams;
  }
