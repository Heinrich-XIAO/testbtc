...
// 2.0% drop, 50% profit, 10% stop, 45 hold
...
export interface StratIter227EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter227EStrategy extends BaseIterStrategy<StratIter227EParams> {
  constructor(params: Partial<StratIter227EParams> = {}) {
    super('strat_iter227_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 45, risk: 0.3 }, params);
  }
