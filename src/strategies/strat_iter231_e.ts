...
export interface StratIter231EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter231EStrategy extends BaseIterStrategy<StratIter231EParams> {
  constructor(params: Partial<StratIter231EParams> = {}) {
    super('strat_iter231_e.params.json', { drop_pct: 0.015, stop_loss: 0.08, trailing_stop: 0.08, max_hold: 25, risk: 0.3 }, params);
  }
