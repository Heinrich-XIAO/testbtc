...
export interface StratIter179BParams extends StrategyParams { rsi_period: number; rsi_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter179BStrategy extends BaseIterStrategy<StratIter179BParams> {
  constructor(params: Partial<StratIter179BParams> = {}) { super('strat_iter179_b.params.json', { rsi_period: 14, rsi_oversold: 30, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
