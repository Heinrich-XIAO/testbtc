...
// 35% profit target with 8% stop loss
...
export interface StratIter211CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter211CStrategy extends BaseIterStrategy<StratIter211CParams> {
  constructor(params: Partial<StratIter211CParams> = {}) {
    super('strat_iter211_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
