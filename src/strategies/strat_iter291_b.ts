...
// Grid: 1.5% drop, 8% stop, 40% profit, 20 hold, 20% risk
...
export interface StratIter291BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter291BStrategy extends BaseIterStrategy<StratIter291BParams> {
  constructor(params: Partial<StratIter291BParams> = {}) {
    super('strat_iter291_b.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
