...
export interface StratIter205DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter205DStrategy extends BaseIterStrategy<StratIter205DParams> {
  constructor(params: Partial<StratIter205DParams> = {}) {
    super('strat_iter205_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.40 }, params);
  }
