...
// 45 bar hold, 45% profit, 10% stop, 20% risk, 1.0% drop
...
export interface StratIter246AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter246AStrategy extends BaseIterStrategy<StratIter246AParams> {
  constructor(params: Partial<StratIter246AParams> = {}) {
    super('strat_iter246_a.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 45, risk: 0.2 }, params);
  }
