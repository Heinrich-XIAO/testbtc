...
export interface StratIter274DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter274DStrategy extends BaseIterStrategy<StratIter274DParams> {
  constructor(params: Partial<StratIter274DParams> = {}) {
    super('strat_iter274_d.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
