...
export interface StratIter296EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter296EStrategy extends BaseIterStrategy<StratIter296EParams> {
  constructor(params: Partial<StratIter296EParams> = {}) {
    super('strat_iter296_e.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
