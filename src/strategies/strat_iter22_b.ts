...
export interface StratIter22BParams extends StrategyParams {
...
const defaultParams: StratIter22BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter22BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter22_b.params.json');
...
export class StratIter22BStrategy implements Strategy {
  params: StratIter22BParams;
  ...
  constructor(params: Partial<StratIter22BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter22BParams;
  }
