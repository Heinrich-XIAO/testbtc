...
// Grid: 2.0% drop, 10% stop, 35% profit, 15 hold, 30% risk
...
export interface StratIter269EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter269EStrategy extends BaseIterStrategy<StratIter269EParams> {
  constructor(params: Partial<StratIter269EParams> = {}) {
    super('strat_iter269_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
