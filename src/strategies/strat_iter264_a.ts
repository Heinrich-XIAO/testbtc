...
export interface StratIter264AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter264AStrategy extends BaseIterStrategy<StratIter264AParams> {
  constructor(params: Partial<StratIter264AParams> = {}) {
    super('strat_iter264_a.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
