...
// 2.0% drop, 50% profit, 10% stop, 35 hold
...
export interface StratIter227CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter227CStrategy extends BaseIterStrategy<StratIter227CParams> {
  constructor(params: Partial<StratIter227CParams> = {}) {
    super('strat_iter227_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.3 }, params);
  }
