...
export interface StratIter294EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter294EStrategy extends BaseIterStrategy<StratIter294EParams> {
  constructor(params: Partial<StratIter294EParams> = {}) {
    super('strat_iter294_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
