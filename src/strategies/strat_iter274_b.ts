...
export interface StratIter274BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter274BStrategy extends BaseIterStrategy<StratIter274BParams> {
  constructor(params: Partial<StratIter274BParams> = {}) {
    super('strat_iter274_b.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
