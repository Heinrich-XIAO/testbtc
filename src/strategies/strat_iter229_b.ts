...
// 3.0% drop, 50% profit, 12% stop, 30 hold
...
export interface StratIter229BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter229BStrategy extends BaseIterStrategy<StratIter229BParams> {
  constructor(params: Partial<StratIter229BParams> = {}) {
    super('strat_iter229_b.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.3 }, params);
  }
