...
export interface StratIter4CParams extends StrategyParams {
...
const defaultParams: StratIter4CParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter4CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter4_c.params.json');
...
export class StratIter4CStrategy implements Strategy {
  params: StratIter4CParams;
  ...
  constructor(params: Partial<StratIter4CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter4CParams;
  }
