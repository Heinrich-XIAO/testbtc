...
// 1.0% drop, 45% profit, 10% stop, 45 hold
...
export interface StratIter225EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter225EStrategy extends BaseIterStrategy<StratIter225EParams> {
  constructor(params: Partial<StratIter225EParams> = {}) {
    super('strat_iter225_e.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 45, risk: 0.3 }, params);
  }
