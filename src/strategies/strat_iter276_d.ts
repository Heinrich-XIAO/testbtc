...
// Grid: 2.5% drop, 15% stop, 35% profit, 15 hold, 50% risk
...
export interface StratIter276DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter276DStrategy extends BaseIterStrategy<StratIter276DParams> {
  constructor(params: Partial<StratIter276DParams> = {}) {
    super('strat_iter276_d.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
