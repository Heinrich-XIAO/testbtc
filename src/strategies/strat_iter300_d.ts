...
export interface StratIter300DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter300DStrategy extends BaseIterStrategy<StratIter300DParams> {
  constructor(params: Partial<StratIter300DParams> = {}) {
    super('strat_iter300_d.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
