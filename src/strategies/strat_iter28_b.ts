...
export interface StratIter28BParams extends StrategyParams {
...
const defaultParams: StratIter28BParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter28BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter28_b.params.json');
...
export class StratIter28BStrategy implements Strategy {
  params: StratIter28BParams;
  ...
  constructor(params: Partial<StratIter28BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter28BParams;
  }
