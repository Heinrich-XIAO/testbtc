...
export interface StratIter194CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter194CStrategy extends BaseIterStrategy<StratIter194CParams> {
  constructor(params: Partial<StratIter194CParams> = {}) { super('strat_iter194_c.params.json', { fast_period: 20, slow_period: 50, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
