...
export interface StratIter188CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter188CStrategy extends BaseIterStrategy<StratIter188CParams> {
  constructor(params: Partial<StratIter188CParams> = {}) { super('strat_iter188_c.params.json', { fast_period: 10, slow_period: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
