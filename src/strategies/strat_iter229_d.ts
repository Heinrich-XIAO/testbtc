...
// 3.0% drop, 50% profit, 12% stop, 40 hold
...
export interface StratIter229DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter229DStrategy extends BaseIterStrategy<StratIter229DParams> {
  constructor(params: Partial<StratIter229DParams> = {}) {
    super('strat_iter229_d.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.3 }, params);
  }
