...
export interface StratIter19AParams extends StrategyParams {
...
const defaultParams: StratIter19AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter19AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter19_a.params.json');
...
export class StratIter19AStrategy implements Strategy {
  params: StratIter19AParams;
  ...
  constructor(params: Partial<StratIter19AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter19AParams;
  }
