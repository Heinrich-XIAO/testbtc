...
export interface StratIter251CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter251CStrategy extends BaseIterStrategy<StratIter251CParams> {
  constructor(params: Partial<StratIter251CParams> = {}) {
    super('strat_iter251_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.4 }, params);
  }
