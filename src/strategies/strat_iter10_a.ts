...
export interface StratIter10AParams extends StrategyParams {
...
const defaultParams: StratIter10AParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 88,
...
function loadSavedParams(): Partial<StratIter10AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter10_a.params.json');
...
export class StratIter10AStrategy implements Strategy {
  params: StratIter10AParams;
  ...
  constructor(params: Partial<StratIter10AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter10AParams;
  }
