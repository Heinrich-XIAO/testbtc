...
export interface StratIter175EParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter175EStrategy extends BaseIterStrategy<StratIter175EParams> {
  constructor(params: Partial<StratIter175EParams> = {}) { super('strat_iter175_e.params.json', { stoch_period: 14, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.20, max_hold_bars: 24, risk_percent: 0.25 }, params); }
