...
export interface StratIter274AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter274AStrategy extends BaseIterStrategy<StratIter274AParams> {
  constructor(params: Partial<StratIter274AParams> = {}) {
    super('strat_iter274_a.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
