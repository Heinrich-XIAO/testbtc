...
export interface StratIter7CParams extends StrategyParams {
...
const defaultParams: StratIter7CParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter7CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter7_c.params.json');
...
export class StratIter7CStrategy implements Strategy {
  params: StratIter7CParams;
  ...
  constructor(params: Partial<StratIter7CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter7CParams;
  }
