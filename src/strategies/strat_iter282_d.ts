...
export interface StratIter282DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter282DStrategy extends BaseIterStrategy<StratIter282DParams> {
  constructor(params: Partial<StratIter282DParams> = {}) {
    super('strat_iter282_d.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
