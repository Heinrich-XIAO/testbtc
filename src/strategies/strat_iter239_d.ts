...
// 3.0% drop, 10% trail, 8% stop, 35 hold, 40% risk
...
export interface StratIter239DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter239DStrategy extends BaseIterStrategy<StratIter239DParams> {
  constructor(params: Partial<StratIter239DParams> = {}) {
    super('strat_iter239_d.params.json', { drop_pct: 0.03, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 35, risk: 0.4 }, params);
  }
