...
// 1.5% drop, 45% profit, 9% stop, 25 hold
...
export interface StratIter230AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter230AStrategy extends BaseIterStrategy<StratIter230AParams> {
  constructor(params: Partial<StratIter230AParams> = {}) {
    super('strat_iter230_a.params.json', { drop_pct: 0.015, stop_loss: 0.09, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
