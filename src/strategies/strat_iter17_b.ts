...
export interface StratIter17BParams extends StrategyParams {
...
const defaultParams: StratIter17BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter17BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter17_b.params.json');
...
export class StratIter17BStrategy implements Strategy {
  params: StratIter17BParams;
  ...
  constructor(params: Partial<StratIter17BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter17BParams;
  }
