...
export interface StratIter276BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter276BStrategy extends BaseIterStrategy<StratIter276BParams> {
  constructor(params: Partial<StratIter276BParams> = {}) {
    super('strat_iter276_b.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
