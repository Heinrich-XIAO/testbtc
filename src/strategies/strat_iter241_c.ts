...
export interface StratIter241CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter241CStrategy extends BaseIterStrategy<StratIter241CParams> {
  constructor(params: Partial<StratIter241CParams> = {}) {
    super('strat_iter241_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.3 }, params);
  }
