...
export interface StratIter299BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter299BStrategy extends BaseIterStrategy<StratIter299BParams> {
  constructor(params: Partial<StratIter299BParams> = {}) {
    super('strat_iter299_b.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
