...
export interface StratIter208CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter208CStrategy extends BaseIterStrategy<StratIter208CParams> {
  constructor(params: Partial<StratIter208CParams> = {}) {
    super('strat_iter208_c.params.json', { drop_pct: 0.04, stop_loss: 0.08, profit_target: 0.25, max_hold: 5, risk: 0.40 }, params);
  }
