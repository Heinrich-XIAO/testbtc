...
// 35% profit target with 4% stop loss
...
export interface StratIter211AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter211AStrategy extends BaseIterStrategy<StratIter211AParams> {
  constructor(params: Partial<StratIter211AParams> = {}) {
    super('strat_iter211_a.params.json', { drop_pct: 0.02, stop_loss: 0.04, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
