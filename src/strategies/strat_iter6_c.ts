...
export interface StratIter6CParams extends StrategyParams {
...
const defaultParams: StratIter6CParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter6CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter6_c.params.json');
...
export class StratIter6CStrategy implements Strategy {
  params: StratIter6CParams;
  ...
  constructor(params: Partial<StratIter6CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter6CParams;
  }
