...
export interface StratIter285CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter285CStrategy extends BaseIterStrategy<StratIter285CParams> {
  constructor(params: Partial<StratIter285CParams> = {}) {
    super('strat_iter285_c.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
