...
// 2% drop entry with 45% profit target
...
export interface StratIter222CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter222CStrategy extends BaseIterStrategy<StratIter222CParams> {
  constructor(params: Partial<StratIter222CParams> = {}) {
    super('strat_iter222_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
