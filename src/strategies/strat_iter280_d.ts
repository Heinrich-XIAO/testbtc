...
// Grid: 2.0% drop, 15% stop, 25% profit, 35 hold, 50% risk
...
export interface StratIter280DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter280DStrategy extends BaseIterStrategy<StratIter280DParams> {
  constructor(params: Partial<StratIter280DParams> = {}) {
    super('strat_iter280_d.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
