...
export interface StratIter280BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter280BStrategy extends BaseIterStrategy<StratIter280BParams> {
  constructor(params: Partial<StratIter280BParams> = {}) {
    super('strat_iter280_b.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
