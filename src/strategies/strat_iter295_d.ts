...
export interface StratIter295DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter295DStrategy extends BaseIterStrategy<StratIter295DParams> {
  constructor(params: Partial<StratIter295DParams> = {}) {
    super('strat_iter295_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
