...
export interface StratIter202AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter202AStrategy extends BaseIterStrategy<StratIter202AParams> {
  constructor(params: Partial<StratIter202AParams> = {}) {
    super('strat_iter202_a.params.json', { drop_pct: 0.02, stop_loss: 0.04, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
