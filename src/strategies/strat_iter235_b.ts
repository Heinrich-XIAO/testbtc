...
// 1.0% drop, 10% trail, 8% stop, 25 hold, 30% risk
...
export interface StratIter235BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter235BStrategy extends BaseIterStrategy<StratIter235BParams> {
  constructor(params: Partial<StratIter235BParams> = {}) {
    super('strat_iter235_b.params.json', { drop_pct: 0.01, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 25, risk: 0.3 }, params);
  }
