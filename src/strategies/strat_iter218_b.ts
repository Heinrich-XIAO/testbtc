...
// 50% profit, 10% stop, 35 hold, 35% risk
...
export interface StratIter218BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter218BStrategy extends BaseIterStrategy<StratIter218BParams> {
  constructor(params: Partial<StratIter218BParams> = {}) {
    super('strat_iter218_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.35 }, params);
  }
