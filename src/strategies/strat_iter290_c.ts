...
export interface StratIter290CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter290CStrategy extends BaseIterStrategy<StratIter290CParams> {
  constructor(params: Partial<StratIter290CParams> = {}) {
    super('strat_iter290_c.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
