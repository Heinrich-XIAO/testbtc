...
// Grid: 2.5% drop, 8% stop, 30% profit, 40 hold, 20% risk
...
export interface StratIter284AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter284AStrategy extends BaseIterStrategy<StratIter284AParams> {
  constructor(params: Partial<StratIter284AParams> = {}) {
    super('strat_iter284_a.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
