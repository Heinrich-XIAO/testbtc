...
// 1.0% drop, 40% profit, 8% stop, 45 hold
...
export interface StratIter224EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter224EStrategy extends BaseIterStrategy<StratIter224EParams> {
  constructor(params: Partial<StratIter224EParams> = {}) {
    super('strat_iter224_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 45, risk: 0.3 }, params);
  }
