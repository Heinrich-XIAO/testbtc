...
export interface StratIter202DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter202DStrategy extends BaseIterStrategy<StratIter202DParams> {
  constructor(params: Partial<StratIter202DParams> = {}) {
    super('strat_iter202_d.params.json', { drop_pct: 0.02, stop_loss: 0.10, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
