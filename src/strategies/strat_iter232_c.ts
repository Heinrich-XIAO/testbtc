...
export interface StratIter232CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter232CStrategy extends BaseIterStrategy<StratIter232CParams> {
  constructor(params: Partial<StratIter232CParams> = {}) {
    super('strat_iter232_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, trailing_stop: 0.15, max_hold: 25, risk: 0.3 }, params);
  }
