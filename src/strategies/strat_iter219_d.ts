...
// 40% profit, 12% stop, 35 hold, 45% risk
...
export interface StratIter219DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter219DStrategy extends BaseIterStrategy<StratIter219DParams> {
  constructor(params: Partial<StratIter219DParams> = {}) {
    super('strat_iter219_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 35, risk: 0.45 }, params);
  }
