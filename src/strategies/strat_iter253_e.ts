...
export interface StratIter253EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter253EStrategy extends BaseIterStrategy<StratIter253EParams> {
  constructor(params: Partial<StratIter253EParams> = {}) {
    super('strat_iter253_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.6 }, params);
  }
