...
export interface StratIter268BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter268BStrategy extends BaseIterStrategy<StratIter268BParams> {
  constructor(params: Partial<StratIter268BParams> = {}) {
    super('strat_iter268_b.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
