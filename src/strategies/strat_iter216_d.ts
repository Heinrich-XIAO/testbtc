...
// 40% profit, 8% stop, 30 hold, 45% risk
...
export interface StratIter216DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter216DStrategy extends BaseIterStrategy<StratIter216DParams> {
  constructor(params: Partial<StratIter216DParams> = {}) {
    super('strat_iter216_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 30, risk: 0.45 }, params);
  }
