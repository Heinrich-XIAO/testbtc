...
export interface StratIter209EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter209EStrategy extends BaseIterStrategy<StratIter209EParams> {
  constructor(params: Partial<StratIter209EParams> = {}) {
    super('strat_iter209_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.15, max_hold: 25, risk: 0.35 }, params);
  }
