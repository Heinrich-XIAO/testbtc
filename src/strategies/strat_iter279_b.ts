...
// Grid: 3.0% drop, 8% stop, 40% profit, 20 hold, 20% risk
...
export interface StratIter279BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter279BStrategy extends BaseIterStrategy<StratIter279BParams> {
  constructor(params: Partial<StratIter279BParams> = {}) {
    super('strat_iter279_b.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
