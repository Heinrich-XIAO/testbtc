...
export interface StratIter293BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter293BStrategy extends BaseIterStrategy<StratIter293BParams> {
  constructor(params: Partial<StratIter293BParams> = {}) {
    super('strat_iter293_b.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
