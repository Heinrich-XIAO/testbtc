...
// 1.0% drop, 45% profit, 10% stop, 35 hold
...
export interface StratIter225CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter225CStrategy extends BaseIterStrategy<StratIter225CParams> {
  constructor(params: Partial<StratIter225CParams> = {}) {
    super('strat_iter225_c.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 35, risk: 0.3 }, params);
  }
