...
export interface StratIter209BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter209BStrategy extends BaseIterStrategy<StratIter209BParams> {
  constructor(params: Partial<StratIter209BParams> = {}) {
    super('strat_iter209_b.params.json', { drop_pct: 0.03, stop_loss: 0.06, profit_target: 0.15, max_hold: 20, risk: 0.30 }, params);
  }
