...
export interface StratIter262AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter262AStrategy extends BaseIterStrategy<StratIter262AParams> {
  constructor(params: Partial<StratIter262AParams> = {}) {
    super('strat_iter262_a.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
