...
export interface StratIter19CParams extends StrategyParams {
...
const defaultParams: StratIter19CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter19CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter19_c.params.json');
...
export class StratIter19CStrategy implements Strategy {
  params: StratIter19CParams;
  ...
  constructor(params: Partial<StratIter19CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter19CParams;
  }
