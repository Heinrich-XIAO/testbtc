...
export interface StratIter203AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter203AStrategy extends BaseIterStrategy<StratIter203AParams> {
  constructor(params: Partial<StratIter203AParams> = {}) {
    super('strat_iter203_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.10, max_hold: 15, risk: 0.25 }, params);
  }
