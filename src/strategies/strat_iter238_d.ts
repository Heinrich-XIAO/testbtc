...
// 2.0% drop, 15% trail, 10% stop, 35 hold, 40% risk
...
export interface StratIter238DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter238DStrategy extends BaseIterStrategy<StratIter238DParams> {
  constructor(params: Partial<StratIter238DParams> = {}) {
    super('strat_iter238_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, trailing_stop: 0.15, max_hold: 35, risk: 0.4 }, params);
  }
