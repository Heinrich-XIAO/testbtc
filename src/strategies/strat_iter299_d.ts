...
export interface StratIter299DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter299DStrategy extends BaseIterStrategy<StratIter299DParams> {
  constructor(params: Partial<StratIter299DParams> = {}) {
    super('strat_iter299_d.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
