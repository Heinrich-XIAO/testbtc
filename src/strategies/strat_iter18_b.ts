...
export interface StratIter18BParams extends StrategyParams {
...
const defaultParams: StratIter18BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter18BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter18_b.params.json');
...
export class StratIter18BStrategy implements Strategy {
  params: StratIter18BParams;
  ...
  constructor(params: Partial<StratIter18BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter18BParams;
  }
