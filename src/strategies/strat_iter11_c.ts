...
export interface StratIter11CParams extends StrategyParams {
...
const defaultParams: StratIter11CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter11CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter11_c.params.json');
...
export class StratIter11CStrategy implements Strategy {
  params: StratIter11CParams;
  ...
  constructor(params: Partial<StratIter11CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter11CParams;
  }
