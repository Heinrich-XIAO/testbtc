...
// 25 bar hold, 35% profit, 6% stop, 40% risk, 3.0% drop
...
export interface StratIter249CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter249CStrategy extends BaseIterStrategy<StratIter249CParams> {
  constructor(params: Partial<StratIter249CParams> = {}) {
    super('strat_iter249_c.params.json', { drop_pct: 0.03, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.4 }, params);
  }
