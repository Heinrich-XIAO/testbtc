...
export interface StratIter191CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter191CStrategy extends BaseIterStrategy<StratIter191CParams> {
  constructor(params: Partial<StratIter191CParams> = {}) { super('strat_iter191_c.params.json', { fast_period: 100, slow_period: 200, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
