...
export interface StratIter278DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter278DStrategy extends BaseIterStrategy<StratIter278DParams> {
  constructor(params: Partial<StratIter278DParams> = {}) {
    super('strat_iter278_d.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
