...
export interface StratIter26AParams extends StrategyParams {
...
const defaultParams: StratIter26AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter26AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter26_a.params.json');
...
export class StratIter26AStrategy implements Strategy {
  params: StratIter26AParams;
  ...
  constructor(params: Partial<StratIter26AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter26AParams;
  }
