...
export interface StratIter263EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter263EStrategy extends BaseIterStrategy<StratIter263EParams> {
  constructor(params: Partial<StratIter263EParams> = {}) {
    super('strat_iter263_e.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
