...
export interface StratIter177AParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter177AStrategy extends BaseIterStrategy<StratIter177AParams> {
  constructor(params: Partial<StratIter177AParams> = {}) { super('strat_iter177_a.params.json', { stoch_period: 7, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
