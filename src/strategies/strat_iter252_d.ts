...
export interface StratIter252DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter252DStrategy extends BaseIterStrategy<StratIter252DParams> {
  constructor(params: Partial<StratIter252DParams> = {}) {
    super('strat_iter252_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 35, risk: 0.5 }, params);
  }
