...
export interface StratIter265CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter265CStrategy extends BaseIterStrategy<StratIter265CParams> {
  constructor(params: Partial<StratIter265CParams> = {}) {
    super('strat_iter265_c.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
