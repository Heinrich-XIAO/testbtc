...
export interface StratIter19BParams extends StrategyParams {
...
const defaultParams: StratIter19BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter19BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter19_b.params.json');
...
export class StratIter19BStrategy implements Strategy {
  params: StratIter19BParams;
  ...
  constructor(params: Partial<StratIter19BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter19BParams;
  }
