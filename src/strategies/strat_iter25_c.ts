...
export interface StratIter25CParams extends StrategyParams {
...
const defaultParams: StratIter25CParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 51,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter25CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter25_c.params.json');
...
export class StratIter25CStrategy implements Strategy {
  params: StratIter25CParams;
  ...
  constructor(params: Partial<StratIter25CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter25CParams;
  }
