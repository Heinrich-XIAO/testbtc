...
// 75% risk, 2.5% drop, 50% profit, 12% stop, 40 hold
...
export interface StratIter259DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter259DStrategy extends BaseIterStrategy<StratIter259DParams> {
  constructor(params: Partial<StratIter259DParams> = {}) {
    super('strat_iter259_d.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.75 }, params);
  }
