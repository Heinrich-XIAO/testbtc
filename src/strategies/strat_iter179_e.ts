...
export interface StratIter179EParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter179EStrategy extends BaseIterStrategy<StratIter179EParams> {
  constructor(params: Partial<StratIter179EParams> = {}) { super('strat_iter179_e.params.json', { stoch_period: 14, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
