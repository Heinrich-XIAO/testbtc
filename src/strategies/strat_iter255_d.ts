...
export interface StratIter255DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter255DStrategy extends BaseIterStrategy<StratIter255DParams> {
  constructor(params: Partial<StratIter255DParams> = {}) {
    super('strat_iter255_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.8 }, params);
  }
