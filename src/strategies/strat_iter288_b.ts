...
// Grid: 2.5% drop, 10% stop, 25% profit, 35 hold, 30% risk
...
export interface StratIter288BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter288BStrategy extends BaseIterStrategy<StratIter288BParams> {
  constructor(params: Partial<StratIter288BParams> = {}) {
    super('strat_iter288_b.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
