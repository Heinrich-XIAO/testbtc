...
export interface StratIter233BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter233BStrategy extends BaseIterStrategy<StratIter233BParams> {
  constructor(params: Partial<StratIter233BParams> = {}) {
    super('strat_iter233_b.params.json', { drop_pct: 0.03, stop_loss: 0.12, trailing_stop: 0.1, max_hold: 25, risk: 0.3 }, params);
  }
