...
export interface StratIter119DParams extends StrategyParams {
...
export class StratIter119DStrategy extends BaseIterStrategy<StratIter119DParams> {
  constructor(params: Partial<StratIter119DParams> = {}) {
    super('strat_iter119_d.params.json', {
      swing_lookback: 3,
      stoch_oversold: 16,
      stop_loss: 0.08,
      profit_target: 0.18,
  ...
  onNext(ctx: BacktestContext, bar: Bar): void {
    ...
    if (shouldSkipPrice(bar.close) || series.swingLows.length < 2) return;
