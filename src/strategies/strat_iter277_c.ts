...
export interface StratIter277CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter277CStrategy extends BaseIterStrategy<StratIter277CParams> {
  constructor(params: Partial<StratIter277CParams> = {}) {
    super('strat_iter277_c.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
