...
// 2.0% drop, 5% trail, 6% stop, 25 hold, 30% risk
...
export interface StratIter236BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter236BStrategy extends BaseIterStrategy<StratIter236BParams> {
  constructor(params: Partial<StratIter236BParams> = {}) {
    super('strat_iter236_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 25, risk: 0.3 }, params);
  }
