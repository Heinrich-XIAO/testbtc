...
export interface StratIter297CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter297CStrategy extends BaseIterStrategy<StratIter297CParams> {
  constructor(params: Partial<StratIter297CParams> = {}) {
    super('strat_iter297_c.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
