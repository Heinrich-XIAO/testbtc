...
export interface StratIter278BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter278BStrategy extends BaseIterStrategy<StratIter278BParams> {
  constructor(params: Partial<StratIter278BParams> = {}) {
    super('strat_iter278_b.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
