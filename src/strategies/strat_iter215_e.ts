...
// 35% profit, 8% stop, 30 hold, 50% risk
...
export interface StratIter215EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter215EStrategy extends BaseIterStrategy<StratIter215EParams> {
  constructor(params: Partial<StratIter215EParams> = {}) {
    super('strat_iter215_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 30, risk: 0.5 }, params);
  }
