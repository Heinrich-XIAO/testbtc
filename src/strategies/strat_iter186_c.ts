...
export interface StratIter186CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter186CStrategy extends BaseIterStrategy<StratIter186CParams> {
  constructor(params: Partial<StratIter186CParams> = {}) { super('strat_iter186_c.params.json', { fast_period: 100, slow_period: 200, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
