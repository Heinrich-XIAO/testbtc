...
export interface StratIter24AParams extends StrategyParams {
...
const defaultParams: StratIter24AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 51,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter24AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter24_a.params.json');
...
export class StratIter24AStrategy implements Strategy {
  params: StratIter24AParams;
  ...
  constructor(params: Partial<StratIter24AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter24AParams;
  }
