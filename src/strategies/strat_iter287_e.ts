...
export interface StratIter287EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter287EStrategy extends BaseIterStrategy<StratIter287EParams> {
  constructor(params: Partial<StratIter287EParams> = {}) {
    super('strat_iter287_e.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
