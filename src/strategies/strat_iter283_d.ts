...
export interface StratIter283DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter283DStrategy extends BaseIterStrategy<StratIter283DParams> {
  constructor(params: Partial<StratIter283DParams> = {}) {
    super('strat_iter283_d.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
