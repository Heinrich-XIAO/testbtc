...
export interface StratIter22AParams extends StrategyParams {
...
const defaultParams: StratIter22AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_lookback: 52,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter22AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter22_a.params.json');
...
export class StratIter22AStrategy implements Strategy {
  params: StratIter22AParams;
  ...
  constructor(params: Partial<StratIter22AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter22AParams;
  }
