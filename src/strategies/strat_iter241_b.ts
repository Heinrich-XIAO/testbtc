...
// 30 bar hold with 40% profit target
...
export interface StratIter241BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter241BStrategy extends BaseIterStrategy<StratIter241BParams> {
  constructor(params: Partial<StratIter241BParams> = {}) {
    super('strat_iter241_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.4, max_hold: 30, risk: 0.3 }, params);
  }
