...
export interface StratIter293EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter293EStrategy extends BaseIterStrategy<StratIter293EParams> {
  constructor(params: Partial<StratIter293EParams> = {}) {
    super('strat_iter293_e.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
