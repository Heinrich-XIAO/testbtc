...
export interface StratIter18AParams extends StrategyParams {
...
const defaultParams: StratIter18AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter18AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter18_a.params.json');
...
export class StratIter18AStrategy implements Strategy {
  params: StratIter18AParams;
  ...
  constructor(params: Partial<StratIter18AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter18AParams;
  }
