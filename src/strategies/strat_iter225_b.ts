...
// 1.0% drop, 45% profit, 10% stop, 30 hold
...
export interface StratIter225BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter225BStrategy extends BaseIterStrategy<StratIter225BParams> {
  constructor(params: Partial<StratIter225BParams> = {}) {
    super('strat_iter225_b.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.3 }, params);
  }
