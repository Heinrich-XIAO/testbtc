...
export interface StratIter252AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter252AStrategy extends BaseIterStrategy<StratIter252AParams> {
  constructor(params: Partial<StratIter252AParams> = {}) {
    super('strat_iter252_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 25, risk: 0.5 }, params);
  }
