...
export interface StratIter294CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter294CStrategy extends BaseIterStrategy<StratIter294CParams> {
  constructor(params: Partial<StratIter294CParams> = {}) {
    super('strat_iter294_c.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
