...
export interface StratIter206EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter206EStrategy extends BaseIterStrategy<StratIter206EParams> {
  constructor(params: Partial<StratIter206EParams> = {}) {
    super('strat_iter206_e.params.json', { drop_pct: 0.04, stop_loss: 0.08, profit_target: 0.30, max_hold: 25, risk: 0.40 }, params);
  }
