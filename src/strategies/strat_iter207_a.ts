...
export interface StratIter207AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter207AStrategy extends BaseIterStrategy<StratIter207AParams> {
  constructor(params: Partial<StratIter207AParams> = {}) {
    super('strat_iter207_a.params.json', { drop_pct: 0.01, stop_loss: 0.10, profit_target: 0.15, max_hold: 20, risk: 0.25 }, params);
  }
