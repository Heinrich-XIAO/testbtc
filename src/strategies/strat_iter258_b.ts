...
// 65% risk, 2.0% drop, 50% profit, 10% stop, 30 hold
...
export interface StratIter258BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter258BStrategy extends BaseIterStrategy<StratIter258BParams> {
  constructor(params: Partial<StratIter258BParams> = {}) {
    super('strat_iter258_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 30, risk: 0.65 }, params);
  }
