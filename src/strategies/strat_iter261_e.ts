...
export interface StratIter261EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter261EStrategy extends BaseIterStrategy<StratIter261EParams> {
  constructor(params: Partial<StratIter261EParams> = {}) {
    super('strat_iter261_e.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
