...
export interface StratIter279AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter279AStrategy extends BaseIterStrategy<StratIter279AParams> {
  constructor(params: Partial<StratIter279AParams> = {}) {
    super('strat_iter279_a.params.json', { drop_pct: 0.025, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
