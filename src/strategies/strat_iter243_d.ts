...
// 50 bar hold with 50% profit target
...
export interface StratIter243DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter243DStrategy extends BaseIterStrategy<StratIter243DParams> {
  constructor(params: Partial<StratIter243DParams> = {}) {
    super('strat_iter243_d.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.5, max_hold: 50, risk: 0.3 }, params);
  }
