...
export interface StratIter297EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter297EStrategy extends BaseIterStrategy<StratIter297EParams> {
  constructor(params: Partial<StratIter297EParams> = {}) {
    super('strat_iter297_e.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
