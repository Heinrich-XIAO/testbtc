...
// 2.0% drop, 5% trail, 6% stop, 20 hold, 25% risk
...
export interface StratIter236AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter236AStrategy extends BaseIterStrategy<StratIter236AParams> {
  constructor(params: Partial<StratIter236AParams> = {}) {
    super('strat_iter236_a.params.json', { drop_pct: 0.02, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 20, risk: 0.25 }, params);
  }
