...
export interface StratIter291CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter291CStrategy extends BaseIterStrategy<StratIter291CParams> {
  constructor(params: Partial<StratIter291CParams> = {}) {
    super('strat_iter291_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
