...
export interface StratIter196CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter196CStrategy extends BaseIterStrategy<StratIter196CParams> {
  constructor(params: Partial<StratIter196CParams> = {}) { super('strat_iter196_c.params.json', { fast_period: 100, slow_period: 200, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
