...
export interface StratIter177BParams extends StrategyParams { rsi_period: number; rsi_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter177BStrategy extends BaseIterStrategy<StratIter177BParams> {
  constructor(params: Partial<StratIter177BParams> = {}) { super('strat_iter177_b.params.json', { rsi_period: 7, rsi_oversold: 30, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
