...
// 45% profit, 10% stop, 30 hold, 40% risk
...
export interface StratIter217CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter217CStrategy extends BaseIterStrategy<StratIter217CParams> {
  constructor(params: Partial<StratIter217CParams> = {}) {
    super('strat_iter217_c.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.4 }, params);
  }
