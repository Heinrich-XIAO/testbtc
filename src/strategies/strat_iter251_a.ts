...
export interface StratIter251AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter251AStrategy extends BaseIterStrategy<StratIter251AParams> {
  constructor(params: Partial<StratIter251AParams> = {}) {
    super('strat_iter251_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 25, risk: 0.4 }, params);
  }
