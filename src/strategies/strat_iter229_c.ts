...
// 3.0% drop, 50% profit, 12% stop, 35 hold
...
export interface StratIter229CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter229CStrategy extends BaseIterStrategy<StratIter229CParams> {
  constructor(params: Partial<StratIter229CParams> = {}) {
    super('strat_iter229_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 35, risk: 0.3 }, params);
  }
