...
export interface StratIter266CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter266CStrategy extends BaseIterStrategy<StratIter266CParams> {
  constructor(params: Partial<StratIter266CParams> = {}) {
    super('strat_iter266_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
