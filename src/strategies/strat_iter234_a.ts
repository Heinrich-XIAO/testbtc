...
// 1.0% drop, 5% trail, 6% stop, 20 hold, 25% risk
...
export interface StratIter234AParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter234AStrategy extends BaseIterStrategy<StratIter234AParams> {
  constructor(params: Partial<StratIter234AParams> = {}) {
    super('strat_iter234_a.params.json', { drop_pct: 0.01, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 20, risk: 0.25 }, params);
  }
