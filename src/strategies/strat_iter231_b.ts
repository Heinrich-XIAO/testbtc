...
export interface StratIter231BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter231BStrategy extends BaseIterStrategy<StratIter231BParams> {
  constructor(params: Partial<StratIter231BParams> = {}) {
    super('strat_iter231_b.params.json', { drop_pct: 0.01, stop_loss: 0.12, trailing_stop: 0.1, max_hold: 25, risk: 0.3 }, params);
  }
