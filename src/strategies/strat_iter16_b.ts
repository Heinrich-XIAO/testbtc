...
export interface StratIter16BParams extends StrategyParams {
...
const defaultParams: StratIter16BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter16BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter16_b.params.json');
...
export class StratIter16BStrategy implements Strategy {
  params: StratIter16BParams;
  ...
  constructor(params: Partial<StratIter16BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter16BParams;
  }
