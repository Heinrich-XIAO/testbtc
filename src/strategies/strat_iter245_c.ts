...
// 35 bar hold, 50% profit, 10% stop, 40% risk, 3.0% drop
...
export interface StratIter245CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter245CStrategy extends BaseIterStrategy<StratIter245CParams> {
  constructor(params: Partial<StratIter245CParams> = {}) {
    super('strat_iter245_c.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.4 }, params);
  }
