...
// 1.5% drop, 45% profit, 9% stop, 40 hold
...
export interface StratIter230DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter230DStrategy extends BaseIterStrategy<StratIter230DParams> {
  constructor(params: Partial<StratIter230DParams> = {}) {
    super('strat_iter230_d.params.json', { drop_pct: 0.015, stop_loss: 0.09, profit_target: 0.45, max_hold: 40, risk: 0.3 }, params);
  }
