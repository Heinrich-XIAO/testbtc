...
// 3.0% drop, 40% profit, 8% stop, 45 hold
...
export interface StratIter228EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter228EStrategy extends BaseIterStrategy<StratIter228EParams> {
  constructor(params: Partial<StratIter228EParams> = {}) {
    super('strat_iter228_e.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 45, risk: 0.3 }, params);
  }
