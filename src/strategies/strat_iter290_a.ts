...
export interface StratIter290AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter290AStrategy extends BaseIterStrategy<StratIter290AParams> {
  constructor(params: Partial<StratIter290AParams> = {}) {
    super('strat_iter290_a.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
