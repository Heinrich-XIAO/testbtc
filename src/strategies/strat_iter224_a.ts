...
// 1.0% drop, 40% profit, 8% stop, 25 hold
...
export interface StratIter224AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter224AStrategy extends BaseIterStrategy<StratIter224AParams> {
  constructor(params: Partial<StratIter224AParams> = {}) {
    super('strat_iter224_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
