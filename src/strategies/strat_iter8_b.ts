...
export interface StratIter8BParams extends StrategyParams {
...
const defaultParams: StratIter8BParams = {
  stoch_k_period: 14,
  stoch_oversold: 18,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter8BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter8_b.params.json');
...
export class StratIter8BStrategy implements Strategy {
  params: StratIter8BParams;
  ...
  constructor(params: Partial<StratIter8BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter8BParams;
  }
