...
// 30 bar hold with 35% profit target
...
export interface StratIter241AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter241AStrategy extends BaseIterStrategy<StratIter241AParams> {
  constructor(params: Partial<StratIter241AParams> = {}) {
    super('strat_iter241_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 30, risk: 0.3 }, params);
  }
