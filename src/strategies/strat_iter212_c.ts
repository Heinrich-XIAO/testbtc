...
// 40% profit target with 8% stop loss
...
export interface StratIter212CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter212CStrategy extends BaseIterStrategy<StratIter212CParams> {
  constructor(params: Partial<StratIter212CParams> = {}) {
    super('strat_iter212_c.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
