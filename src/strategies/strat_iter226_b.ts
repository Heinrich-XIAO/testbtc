...
// 2.0% drop, 35% profit, 6% stop, 30 hold
...
export interface StratIter226BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter226BStrategy extends BaseIterStrategy<StratIter226BParams> {
  constructor(params: Partial<StratIter226BParams> = {}) {
    super('strat_iter226_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 30, risk: 0.3 }, params);
  }
