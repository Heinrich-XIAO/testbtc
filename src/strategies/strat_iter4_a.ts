...
export interface StratIter4AParams extends StrategyParams {
...
const defaultParams: StratIter4AParams = {
  stoch_k_period: 14,
  stoch_oversold: 14,
  stoch_overbought: 82,
...
function loadSavedParams(): Partial<StratIter4AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter4_a.params.json');
...
export class StratIter4AStrategy implements Strategy {
  params: StratIter4AParams;
  ...
  constructor(params: Partial<StratIter4AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter4AParams;
  }
