...
export interface StratIter273BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter273BStrategy extends BaseIterStrategy<StratIter273BParams> {
  constructor(params: Partial<StratIter273BParams> = {}) {
    super('strat_iter273_b.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
