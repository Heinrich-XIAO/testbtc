...
export interface StratIter294AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter294AStrategy extends BaseIterStrategy<StratIter294AParams> {
  constructor(params: Partial<StratIter294AParams> = {}) {
    super('strat_iter294_a.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
