...
export interface StratIter145DParams extends StrategyParams {
...
export class StratIter145DStrategy extends BaseIterStrategy<StratIter145DParams> {
  constructor(params: Partial<StratIter145DParams> = {}) {
    super('strat_iter145_d.params.json', {
      pivot_lookback: 20,
  ...
  onNext(ctx: BacktestContext, bar: Bar): void {
    ...
    if (shouldSkipPrice(bar.close) || series.highs.length < this.params.pivot_lookback || k === null) return;
