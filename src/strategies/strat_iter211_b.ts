...
// 35% profit target with 6% stop loss
...
export interface StratIter211BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter211BStrategy extends BaseIterStrategy<StratIter211BParams> {
  constructor(params: Partial<StratIter211BParams> = {}) {
    super('strat_iter211_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
