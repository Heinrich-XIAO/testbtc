...
// 50 bar hold with 35% profit target
...
export interface StratIter243AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter243AStrategy extends BaseIterStrategy<StratIter243AParams> {
  constructor(params: Partial<StratIter243AParams> = {}) {
    super('strat_iter243_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 50, risk: 0.3 }, params);
  }
