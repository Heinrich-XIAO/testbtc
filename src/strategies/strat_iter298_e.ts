...
export interface StratIter298EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter298EStrategy extends BaseIterStrategy<StratIter298EParams> {
  constructor(params: Partial<StratIter298EParams> = {}) {
    super('strat_iter298_e.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
