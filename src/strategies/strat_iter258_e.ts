...
// 65% risk, 2.0% drop, 50% profit, 10% stop, 45 hold
...
export interface StratIter258EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter258EStrategy extends BaseIterStrategy<StratIter258EParams> {
  constructor(params: Partial<StratIter258EParams> = {}) {
    super('strat_iter258_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 45, risk: 0.65 }, params);
  }
