...
// 45% profit target with 6% stop loss
...
export interface StratIter213BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter213BStrategy extends BaseIterStrategy<StratIter213BParams> {
  constructor(params: Partial<StratIter213BParams> = {}) {
    super('strat_iter213_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
