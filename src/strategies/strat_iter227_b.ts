...
// 2.0% drop, 50% profit, 10% stop, 30 hold
...
export interface StratIter227BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter227BStrategy extends BaseIterStrategy<StratIter227BParams> {
  constructor(params: Partial<StratIter227BParams> = {}) {
    super('strat_iter227_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 30, risk: 0.3 }, params);
  }
