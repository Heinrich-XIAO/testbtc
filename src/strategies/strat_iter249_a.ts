...
// 25 bar hold, 35% profit, 6% stop, 20% risk, 1.0% drop
...
export interface StratIter249AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter249AStrategy extends BaseIterStrategy<StratIter249AParams> {
  constructor(params: Partial<StratIter249AParams> = {}) {
    super('strat_iter249_a.params.json', { drop_pct: 0.01, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.2 }, params);
  }
