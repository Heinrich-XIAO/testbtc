...
// 35 bar hold, 40% profit, 8% stop, 30% risk, 2.0% drop
...
export interface StratIter244BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter244BStrategy extends BaseIterStrategy<StratIter244BParams> {
  constructor(params: Partial<StratIter244BParams> = {}) {
    super('strat_iter244_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.30000000000000004 }, params);
  }
