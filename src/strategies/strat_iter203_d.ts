...
export interface StratIter203DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter203DStrategy extends BaseIterStrategy<StratIter203DParams> {
  constructor(params: Partial<StratIter203DParams> = {}) {
    super('strat_iter203_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.25, max_hold: 15, risk: 0.25 }, params);
  }
