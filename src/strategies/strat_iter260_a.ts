...
// 50% risk, 2.0% drop, 45% profit, 10% stop, 25 hold
...
export interface StratIter260AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter260AStrategy extends BaseIterStrategy<StratIter260AParams> {
  constructor(params: Partial<StratIter260AParams> = {}) {
    super('strat_iter260_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
