...
export interface StratIter254AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter254AStrategy extends BaseIterStrategy<StratIter254AParams> {
  constructor(params: Partial<StratIter254AParams> = {}) {
    super('strat_iter254_a.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 30, risk: 0.7 }, params);
  }
