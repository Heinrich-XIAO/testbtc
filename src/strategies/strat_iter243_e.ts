...
export interface StratIter243EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter243EStrategy extends BaseIterStrategy<StratIter243EParams> {
  constructor(params: Partial<StratIter243EParams> = {}) {
    super('strat_iter243_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 50, risk: 0.3 }, params);
  }
