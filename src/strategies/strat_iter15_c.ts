...
export interface StratIter15CParams extends StrategyParams {
...
const defaultParams: StratIter15CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter15CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter15_c.params.json');
...
export class StratIter15CStrategy implements Strategy {
  params: StratIter15CParams;
  ...
  constructor(params: Partial<StratIter15CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter15CParams;
  }
