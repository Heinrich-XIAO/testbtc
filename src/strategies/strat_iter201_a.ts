...
export interface StratIter201AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter201AStrategy extends BaseIterStrategy<StratIter201AParams> {
  constructor(params: Partial<StratIter201AParams> = {}) {
    super('strat_iter201_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
