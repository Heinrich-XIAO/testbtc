...
export interface StratIter288CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter288CStrategy extends BaseIterStrategy<StratIter288CParams> {
  constructor(params: Partial<StratIter288CParams> = {}) {
    super('strat_iter288_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
