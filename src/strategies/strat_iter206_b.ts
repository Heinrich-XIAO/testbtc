...
export interface StratIter206BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter206BStrategy extends BaseIterStrategy<StratIter206BParams> {
  constructor(params: Partial<StratIter206BParams> = {}) {
    super('strat_iter206_b.params.json', { drop_pct: 0.04, stop_loss: 0.04, profit_target: 0.20, max_hold: 20, risk: 0.30 }, params);
  }
