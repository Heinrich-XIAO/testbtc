...
// 50 bar hold with 40% profit target
...
export interface StratIter243BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter243BStrategy extends BaseIterStrategy<StratIter243BParams> {
  constructor(params: Partial<StratIter243BParams> = {}) {
    super('strat_iter243_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 50, risk: 0.3 }, params);
  }
