...
// 2.0% drop, 15% trail, 10% stop, 40 hold, 45% risk
...
export interface StratIter238EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter238EStrategy extends BaseIterStrategy<StratIter238EParams> {
  constructor(params: Partial<StratIter238EParams> = {}) {
    super('strat_iter238_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, trailing_stop: 0.15, max_hold: 40, risk: 0.45 }, params);
  }
