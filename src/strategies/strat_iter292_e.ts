...
export interface StratIter292EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter292EStrategy extends BaseIterStrategy<StratIter292EParams> {
  constructor(params: Partial<StratIter292EParams> = {}) {
    super('strat_iter292_e.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
