...
export interface StratIter208BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter208BStrategy extends BaseIterStrategy<StratIter208BParams> {
  constructor(params: Partial<StratIter208BParams> = {}) {
    super('strat_iter208_b.params.json', { drop_pct: 0.03, stop_loss: 0.06, profit_target: 0.30, max_hold: 10, risk: 0.30 }, params);
  }
