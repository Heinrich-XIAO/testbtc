...
// 45% profit, 10% stop, 30 hold, 35% risk
...
export interface StratIter217BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter217BStrategy extends BaseIterStrategy<StratIter217BParams> {
  constructor(params: Partial<StratIter217BParams> = {}) {
    super('strat_iter217_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.35 }, params);
  }
