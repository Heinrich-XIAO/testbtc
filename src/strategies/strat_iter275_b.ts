...
export interface StratIter275BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter275BStrategy extends BaseIterStrategy<StratIter275BParams> {
  constructor(params: Partial<StratIter275BParams> = {}) {
    super('strat_iter275_b.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
