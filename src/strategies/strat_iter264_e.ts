...
export interface StratIter264EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter264EStrategy extends BaseIterStrategy<StratIter264EParams> {
  constructor(params: Partial<StratIter264EParams> = {}) {
    super('strat_iter264_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
