...
export interface StratIter280AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter280AStrategy extends BaseIterStrategy<StratIter280AParams> {
  constructor(params: Partial<StratIter280AParams> = {}) {
    super('strat_iter280_a.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
