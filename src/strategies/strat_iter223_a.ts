...
// 3% drop entry with 35% profit target
...
export interface StratIter223AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter223AStrategy extends BaseIterStrategy<StratIter223AParams> {
  constructor(params: Partial<StratIter223AParams> = {}) {
    super('strat_iter223_a.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
