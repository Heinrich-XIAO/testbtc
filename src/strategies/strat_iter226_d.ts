...
// 2.0% drop, 35% profit, 6% stop, 40 hold
...
export interface StratIter226DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter226DStrategy extends BaseIterStrategy<StratIter226DParams> {
  constructor(params: Partial<StratIter226DParams> = {}) {
    super('strat_iter226_d.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 40, risk: 0.3 }, params);
  }
