...
export interface StratIter283CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter283CStrategy extends BaseIterStrategy<StratIter283CParams> {
  constructor(params: Partial<StratIter283CParams> = {}) {
    super('strat_iter283_c.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
