...
export interface StratIter273CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter273CStrategy extends BaseIterStrategy<StratIter273CParams> {
  constructor(params: Partial<StratIter273CParams> = {}) {
    super('strat_iter273_c.params.json', { drop_pct: 0.03, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
