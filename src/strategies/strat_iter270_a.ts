...
// Grid: 3.0% drop, 12% stop, 50% profit, 30 hold, 40% risk
...
export interface StratIter270AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter270AStrategy extends BaseIterStrategy<StratIter270AParams> {
  constructor(params: Partial<StratIter270AParams> = {}) {
    super('strat_iter270_a.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
