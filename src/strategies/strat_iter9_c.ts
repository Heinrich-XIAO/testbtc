...
export interface StratIter9CParams extends StrategyParams {
...
const defaultParams: StratIter9CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter9CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter9_c.params.json');
...
export class StratIter9CStrategy implements Strategy {
  params: StratIter9CParams;
  ...
  constructor(params: Partial<StratIter9CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter9CParams;
  }
