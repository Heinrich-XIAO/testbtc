...
export interface StratIter209AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter209AStrategy extends BaseIterStrategy<StratIter209AParams> {
  constructor(params: Partial<StratIter209AParams> = {}) {
    super('strat_iter209_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.10, max_hold: 25, risk: 0.25 }, params);
  }
