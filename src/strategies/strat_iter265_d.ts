...
// Grid: 2.0% drop, 8% stop, 40% profit, 20 hold, 20% risk
...
export interface StratIter265DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter265DStrategy extends BaseIterStrategy<StratIter265DParams> {
  constructor(params: Partial<StratIter265DParams> = {}) {
    super('strat_iter265_d.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
