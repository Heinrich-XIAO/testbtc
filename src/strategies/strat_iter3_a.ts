...
export interface StratIter3AParams extends StrategyParams {
...
const defaultParams: StratIter3AParams = {
  stoch_k_period: 14,
  stoch_oversold: 14,
  stoch_overbought: 82,
...
function loadSavedParams(): Partial<StratIter3AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter3_a.params.json');
...
export class StratIter3AStrategy implements Strategy {
  params: StratIter3AParams;
  ...
  constructor(params: Partial<StratIter3AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter3AParams;
  }
