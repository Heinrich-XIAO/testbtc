...
export interface StratIter4BParams extends StrategyParams {
...
const defaultParams: StratIter4BParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter4BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter4_b.params.json');
...
export class StratIter4BStrategy implements Strategy {
  params: StratIter4BParams;
  ...
  constructor(params: Partial<StratIter4BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter4BParams;
  }
