...
export interface StratIter28CParams extends StrategyParams {
...
const defaultParams: StratIter28CParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter28CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter28_c.params.json');
...
export class StratIter28CStrategy implements Strategy {
  params: StratIter28CParams;
  ...
  constructor(params: Partial<StratIter28CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter28CParams;
  }
