...
export interface StratIter189EParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter189EStrategy extends BaseIterStrategy<StratIter189EParams> {
  constructor(params: Partial<StratIter189EParams> = {}) { super('strat_iter189_e.params.json', { stoch_period: 14, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
