...
// 40% profit target with 10% stop loss
...
export interface StratIter212DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter212DStrategy extends BaseIterStrategy<StratIter212DParams> {
  constructor(params: Partial<StratIter212DParams> = {}) {
    super('strat_iter212_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
