...
export interface StratIter205BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter205BStrategy extends BaseIterStrategy<StratIter205BParams> {
  constructor(params: Partial<StratIter205BParams> = {}) {
    super('strat_iter205_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.20 }, params);
  }
