...
// 2.0% drop, 5% trail, 6% stop, 40 hold, 45% risk
...
export interface StratIter236EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter236EStrategy extends BaseIterStrategy<StratIter236EParams> {
  constructor(params: Partial<StratIter236EParams> = {}) {
    super('strat_iter236_e.params.json', { drop_pct: 0.02, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 40, risk: 0.45 }, params);
  }
