...
export interface StratIter295BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter295BStrategy extends BaseIterStrategy<StratIter295BParams> {
  constructor(params: Partial<StratIter295BParams> = {}) {
    super('strat_iter295_b.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
