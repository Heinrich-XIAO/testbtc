...
export interface StratIter288EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter288EStrategy extends BaseIterStrategy<StratIter288EParams> {
  constructor(params: Partial<StratIter288EParams> = {}) {
    super('strat_iter288_e.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
