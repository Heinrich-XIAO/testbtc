...
// 60 bar hold, 40% profit, 12% stop, 20% risk, 1.0% drop
...
export interface StratIter248AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter248AStrategy extends BaseIterStrategy<StratIter248AParams> {
  constructor(params: Partial<StratIter248AParams> = {}) {
    super('strat_iter248_a.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 60, risk: 0.2 }, params);
  }
