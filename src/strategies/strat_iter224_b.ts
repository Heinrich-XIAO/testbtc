...
// 1.0% drop, 40% profit, 8% stop, 30 hold
...
export interface StratIter224BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter224BStrategy extends BaseIterStrategy<StratIter224BParams> {
  constructor(params: Partial<StratIter224BParams> = {}) {
    super('strat_iter224_b.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 30, risk: 0.3 }, params);
  }
