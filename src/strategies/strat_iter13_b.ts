...
export interface StratIter13BParams extends StrategyParams {
...
const defaultParams: StratIter13BParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter13BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter13_b.params.json');
...
export class StratIter13BStrategy implements Strategy {
  params: StratIter13BParams;
  ...
  constructor(params: Partial<StratIter13BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter13BParams;
  }
