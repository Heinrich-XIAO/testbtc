...
// 3% drop entry with 50% profit target
...
export interface StratIter223DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter223DStrategy extends BaseIterStrategy<StratIter223DParams> {
  constructor(params: Partial<StratIter223DParams> = {}) {
    super('strat_iter223_d.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
