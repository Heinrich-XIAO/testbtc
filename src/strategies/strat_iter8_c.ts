...
export interface StratIter8CParams extends StrategyParams {
...
const defaultParams: StratIter8CParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter8CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter8_c.params.json');
...
export class StratIter8CStrategy implements Strategy {
  params: StratIter8CParams;
  ...
  constructor(params: Partial<StratIter8CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter8CParams;
  }
