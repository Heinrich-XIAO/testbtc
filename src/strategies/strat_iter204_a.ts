...
export interface StratIter204AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter204AStrategy extends BaseIterStrategy<StratIter204AParams> {
  constructor(params: Partial<StratIter204AParams> = {}) {
    super('strat_iter204_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.18, max_hold: 5, risk: 0.25 }, params);
  }
