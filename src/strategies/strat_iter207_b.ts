...
export interface StratIter207BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter207BStrategy extends BaseIterStrategy<StratIter207BParams> {
  constructor(params: Partial<StratIter207BParams> = {}) {
    super('strat_iter207_b.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.20, max_hold: 25, risk: 0.20 }, params);
  }
