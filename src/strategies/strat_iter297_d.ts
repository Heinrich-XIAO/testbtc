...
// Grid: 3.0% drop, 8% stop, 50% profit, 30 hold, 20% risk
...
export interface StratIter297DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter297DStrategy extends BaseIterStrategy<StratIter297DParams> {
  constructor(params: Partial<StratIter297DParams> = {}) {
    super('strat_iter297_d.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
