...
export interface StratIter267CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter267CStrategy extends BaseIterStrategy<StratIter267CParams> {
  constructor(params: Partial<StratIter267CParams> = {}) {
    super('strat_iter267_c.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
