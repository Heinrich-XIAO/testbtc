...
export interface StratIter275CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter275CStrategy extends BaseIterStrategy<StratIter275CParams> {
  constructor(params: Partial<StratIter275CParams> = {}) {
    super('strat_iter275_c.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
