...
export interface StratIter16CParams extends StrategyParams {
...
const defaultParams: StratIter16CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter16CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter16_c.params.json');
...
export class StratIter16CStrategy implements Strategy {
  params: StratIter16CParams;
  ...
  constructor(params: Partial<StratIter16CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter16CParams;
  }
