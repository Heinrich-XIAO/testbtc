...
export interface StratIter265EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter265EStrategy extends BaseIterStrategy<StratIter265EParams> {
  constructor(params: Partial<StratIter265EParams> = {}) {
    super('strat_iter265_e.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
