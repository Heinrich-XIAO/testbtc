...
// 50% profit, 10% stop, 35 hold, 30% risk
...
export interface StratIter218AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter218AStrategy extends BaseIterStrategy<StratIter218AParams> {
  constructor(params: Partial<StratIter218AParams> = {}) {
    super('strat_iter218_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 35, risk: 0.3 }, params);
  }
