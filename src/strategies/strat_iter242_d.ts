...
// 40 bar hold with 50% profit target
...
export interface StratIter242DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter242DStrategy extends BaseIterStrategy<StratIter242DParams> {
  constructor(params: Partial<StratIter242DParams> = {}) {
    super('strat_iter242_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.3 }, params);
  }
