...
export interface StratIter279EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter279EStrategy extends BaseIterStrategy<StratIter279EParams> {
  constructor(params: Partial<StratIter279EParams> = {}) {
    super('strat_iter279_e.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.25, max_hold: 35, risk: 0.5 }, params);
  }
