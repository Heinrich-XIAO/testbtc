...
// 1.5% drop, 8% trail, 8% stop, 25 hold, 30% risk
...
export interface StratIter240BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter240BStrategy extends BaseIterStrategy<StratIter240BParams> {
  constructor(params: Partial<StratIter240BParams> = {}) {
    super('strat_iter240_b.params.json', { drop_pct: 0.015, stop_loss: 0.08, trailing_stop: 0.08, max_hold: 25, risk: 0.3 }, params);
  }
