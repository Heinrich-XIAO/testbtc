...
export interface StratIter295CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter295CStrategy extends BaseIterStrategy<StratIter295CParams> {
  constructor(params: Partial<StratIter295CParams> = {}) {
    super('strat_iter295_c.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
