...
export interface StratIter292AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter292AStrategy extends BaseIterStrategy<StratIter292AParams> {
  constructor(params: Partial<StratIter292AParams> = {}) {
    super('strat_iter292_a.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
