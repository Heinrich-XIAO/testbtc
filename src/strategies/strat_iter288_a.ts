...
export interface StratIter288AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter288AStrategy extends BaseIterStrategy<StratIter288AParams> {
  constructor(params: Partial<StratIter288AParams> = {}) {
    super('strat_iter288_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
