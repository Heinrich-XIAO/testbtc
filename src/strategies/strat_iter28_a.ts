...
export interface StratIter28AParams extends StrategyParams {
...
const defaultParams: StratIter28AParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 50,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter28AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter28_a.params.json');
...
export class StratIter28AStrategy implements Strategy {
  params: StratIter28AParams;
  ...
  constructor(params: Partial<StratIter28AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter28AParams;
  }
