...
export interface StratIter281DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter281DStrategy extends BaseIterStrategy<StratIter281DParams> {
  constructor(params: Partial<StratIter281DParams> = {}) {
    super('strat_iter281_d.params.json', { drop_pct: 0.025, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
