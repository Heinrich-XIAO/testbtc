...
// 55% risk, 1.5% drop, 45% profit, 10% stop, 25 hold
...
export interface StratIter257AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter257AStrategy extends BaseIterStrategy<StratIter257AParams> {
  constructor(params: Partial<StratIter257AParams> = {}) {
    super('strat_iter257_a.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.55 }, params);
  }
