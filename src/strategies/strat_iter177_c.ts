...
export interface StratIter177CParams extends StrategyParams { fast_period: number; slow_period: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter177CStrategy extends BaseIterStrategy<StratIter177CParams> {
  constructor(params: Partial<StratIter177CParams> = {}) { super('strat_iter177_c.params.json', { fast_period: 5, slow_period: 10, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
