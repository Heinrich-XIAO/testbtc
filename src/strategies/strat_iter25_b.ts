...
export interface StratIter25BParams extends StrategyParams {
...
const defaultParams: StratIter25BParams = {
  stoch_k_period: 18,
  stoch_d_period: 3,
  stoch_lookback: 51,
  stoch_oversold: 14,
...
function loadSavedParams(): Partial<StratIter25BParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter25_b.params.json');
...
export class StratIter25BStrategy implements Strategy {
  params: StratIter25BParams;
  ...
  constructor(params: Partial<StratIter25BParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter25BParams;
  }
