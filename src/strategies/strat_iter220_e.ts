...
// 50% profit, 12% stop, 40 hold, 50% risk
...
export interface StratIter220EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter220EStrategy extends BaseIterStrategy<StratIter220EParams> {
  constructor(params: Partial<StratIter220EParams> = {}) {
    super('strat_iter220_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 40, risk: 0.5 }, params);
  }
