...
export interface StratIter208EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter208EStrategy extends BaseIterStrategy<StratIter208EParams> {
  constructor(params: Partial<StratIter208EParams> = {}) {
    super('strat_iter208_e.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.30, max_hold: 5, risk: 0.50 }, params);
  }
