...
// 50% profit target with 10% stop loss
...
export interface StratIter214DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter214DStrategy extends BaseIterStrategy<StratIter214DParams> {
  constructor(params: Partial<StratIter214DParams> = {}) {
    super('strat_iter214_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.5, max_hold: 25, risk: 0.3 }, params);
  }
