...
export interface StratIter196AParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter196AStrategy extends BaseIterStrategy<StratIter196AParams> {
  constructor(params: Partial<StratIter196AParams> = {}) { super('strat_iter196_a.params.json', { stoch_period: 30, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
