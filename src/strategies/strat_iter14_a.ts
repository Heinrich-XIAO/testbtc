...
export interface StratIter14AParams extends StrategyParams {
...
const defaultParams: StratIter14AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter14AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter14_a.params.json');
...
export class StratIter14AStrategy implements Strategy {
  params: StratIter14AParams;
  ...
  constructor(params: Partial<StratIter14AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter14AParams;
  }
