...
export interface StratIter202EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter202EStrategy extends BaseIterStrategy<StratIter202EParams> {
  constructor(params: Partial<StratIter202EParams> = {}) {
    super('strat_iter202_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
