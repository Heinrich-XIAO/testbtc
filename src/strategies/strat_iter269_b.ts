...
export interface StratIter269BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter269BStrategy extends BaseIterStrategy<StratIter269BParams> {
  constructor(params: Partial<StratIter269BParams> = {}) {
    super('strat_iter269_b.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
