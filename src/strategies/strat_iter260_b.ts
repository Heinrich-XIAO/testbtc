...
// 50% risk, 2.0% drop, 45% profit, 10% stop, 30 hold
...
export interface StratIter260BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter260BStrategy extends BaseIterStrategy<StratIter260BParams> {
  constructor(params: Partial<StratIter260BParams> = {}) {
    super('strat_iter260_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.5 }, params);
  }
