...
// 35 bar hold, 40% profit, 8% stop, 20% risk, 1.0% drop
...
export interface StratIter244AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter244AStrategy extends BaseIterStrategy<StratIter244AParams> {
  constructor(params: Partial<StratIter244AParams> = {}) {
    super('strat_iter244_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.2 }, params);
  }
