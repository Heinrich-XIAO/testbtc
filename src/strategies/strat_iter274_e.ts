...
export interface StratIter274EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter274EStrategy extends BaseIterStrategy<StratIter274EParams> {
  constructor(params: Partial<StratIter274EParams> = {}) {
    super('strat_iter274_e.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
