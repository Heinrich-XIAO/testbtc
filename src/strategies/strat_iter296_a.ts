...
// Grid: 1.0% drop, 8% stop, 30% profit, 40 hold, 20% risk
...
export interface StratIter296AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter296AStrategy extends BaseIterStrategy<StratIter296AParams> {
  constructor(params: Partial<StratIter296AParams> = {}) {
    super('strat_iter296_a.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
