...
// Grid: 1.0% drop, 10% stop, 45% profit, 25 hold, 30% risk
...
export interface StratIter281AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter281AStrategy extends BaseIterStrategy<StratIter281AParams> {
  constructor(params: Partial<StratIter281AParams> = {}) {
    super('strat_iter281_a.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.45, max_hold: 25, risk: 0.3 }, params);
  }
