...
// 50% risk, 2.0% drop, 45% profit, 10% stop, 45 hold
...
export interface StratIter260EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter260EStrategy extends BaseIterStrategy<StratIter260EParams> {
  constructor(params: Partial<StratIter260EParams> = {}) {
    super('strat_iter260_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 45, risk: 0.5 }, params);
  }
