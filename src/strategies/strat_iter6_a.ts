...
export interface StratIter6AParams extends StrategyParams {
...
const defaultParams: StratIter6AParams = {
  stoch_k_period: 14,
  stoch_oversold: 16,
  stoch_overbought: 84,
...
function loadSavedParams(): Partial<StratIter6AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter6_a.params.json');
...
export class StratIter6AStrategy implements Strategy {
  params: StratIter6AParams;
  ...
  constructor(params: Partial<StratIter6AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter6AParams;
  }
