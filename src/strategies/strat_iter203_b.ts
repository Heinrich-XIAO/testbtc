...
export interface StratIter203BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter203BStrategy extends BaseIterStrategy<StratIter203BParams> {
  constructor(params: Partial<StratIter203BParams> = {}) {
    super('strat_iter203_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.15, max_hold: 15, risk: 0.25 }, params);
  }
