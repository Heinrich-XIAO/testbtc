...
// 40% profit target with 6% stop loss
...
export interface StratIter212BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter212BStrategy extends BaseIterStrategy<StratIter212BParams> {
  constructor(params: Partial<StratIter212BParams> = {}) {
    super('strat_iter212_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.4, max_hold: 25, risk: 0.3 }, params);
  }
