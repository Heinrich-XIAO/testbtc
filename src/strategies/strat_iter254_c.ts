...
export interface StratIter254CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter254CStrategy extends BaseIterStrategy<StratIter254CParams> {
  constructor(params: Partial<StratIter254CParams> = {}) {
    super('strat_iter254_c.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.5, max_hold: 35, risk: 0.7 }, params);
  }
