...
export interface StratIter201Params extends StrategyParams {
...
const defaultParams: StratIter201Params = {
  stoch_k_period: 14,
  stoch_oversold: 14,
  stoch_overbought: 82,
...
function loadSavedParams(): Partial<StratIter201Params> | null {
  const paramsPath = path.join(__dirname, 'strat_iter2_01.params.json');
...
export class StratIter201Strategy implements Strategy {
  params: StratIter201Params;
  ...
  constructor(params: Partial<StratIter201Params> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter201Params;
  }
