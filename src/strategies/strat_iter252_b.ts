...
export interface StratIter252BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter252BStrategy extends BaseIterStrategy<StratIter252BParams> {
  constructor(params: Partial<StratIter252BParams> = {}) {
    super('strat_iter252_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.4, max_hold: 30, risk: 0.5 }, params);
  }
