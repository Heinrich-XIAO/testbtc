...
export interface StratIterStock005Params extends StrategyParams {
  cci_period: number;
  cci_extreme: number;
  cci_tighten: number;
  sr_lookback: number;
...
export class StratIterStock005Strategy extends BaseIterStrategy<StratIterStock005Params> {
  constructor(params: Partial<StratIterStock005Params> = {}) {
    super('strat_iter_stock_005.params.json', {
      cci_period: 14,
      cci_extreme: -100,
      cci_tighten: -80,
      sr_lookback: 50,
  ...
  onNext(ctx: BacktestContext, bar: Bar): void {
    ...
    const cciExtremelyOversold = cciVal < this.params.cci_extreme;
