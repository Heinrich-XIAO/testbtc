...
// 35 bar hold, 40% profit, 8% stop, 60% risk, 1.5% drop
...
export interface StratIter244EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter244EStrategy extends BaseIterStrategy<StratIter244EParams> {
  constructor(params: Partial<StratIter244EParams> = {}) {
    super('strat_iter244_e.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.4, max_hold: 35, risk: 0.6000000000000001 }, params);
  }
