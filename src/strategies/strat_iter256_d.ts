...
// 45% risk, 1.0% drop, 40% profit, 8% stop, 40 hold
...
export interface StratIter256DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter256DStrategy extends BaseIterStrategy<StratIter256DParams> {
  constructor(params: Partial<StratIter256DParams> = {}) {
    super('strat_iter256_d.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 40, risk: 0.45 }, params);
  }
