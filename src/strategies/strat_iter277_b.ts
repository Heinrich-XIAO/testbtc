...
export interface StratIter277BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter277BStrategy extends BaseIterStrategy<StratIter277BParams> {
  constructor(params: Partial<StratIter277BParams> = {}) {
    super('strat_iter277_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
