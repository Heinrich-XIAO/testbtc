...
// 45% profit, 10% stop, 30 hold, 50% risk
...
export interface StratIter217EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter217EStrategy extends BaseIterStrategy<StratIter217EParams> {
  constructor(params: Partial<StratIter217EParams> = {}) {
    super('strat_iter217_e.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.5 }, params);
  }
