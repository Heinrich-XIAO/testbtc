...
// Grid: 1.5% drop, 15% stop, 45% profit, 25 hold, 50% risk
...
export interface StratIter283EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter283EStrategy extends BaseIterStrategy<StratIter283EParams> {
  constructor(params: Partial<StratIter283EParams> = {}) {
    super('strat_iter283_e.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
