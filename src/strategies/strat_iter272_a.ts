...
export interface StratIter272AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter272AStrategy extends BaseIterStrategy<StratIter272AParams> {
  constructor(params: Partial<StratIter272AParams> = {}) {
    super('strat_iter272_a.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
