...
export interface StratIter267DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter267DStrategy extends BaseIterStrategy<StratIter267DParams> {
  constructor(params: Partial<StratIter267DParams> = {}) {
    super('strat_iter267_d.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
