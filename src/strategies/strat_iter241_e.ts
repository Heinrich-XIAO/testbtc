...
// 30 bar hold with 45% profit target
...
export interface StratIter241EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter241EStrategy extends BaseIterStrategy<StratIter241EParams> {
  constructor(params: Partial<StratIter241EParams> = {}) {
    super('strat_iter241_e.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.45, max_hold: 30, risk: 0.3 }, params);
  }
