...
export interface StratIter273AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter273AStrategy extends BaseIterStrategy<StratIter273AParams> {
  constructor(params: Partial<StratIter273AParams> = {}) {
    super('strat_iter273_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
