...
// Grid: 2.0% drop, 15% stop, 35% profit, 15 hold, 50% risk
...
export interface StratIter299EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter299EStrategy extends BaseIterStrategy<StratIter299EParams> {
  constructor(params: Partial<StratIter299EParams> = {}) {
    super('strat_iter299_e.params.json', { drop_pct: 0.02, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
