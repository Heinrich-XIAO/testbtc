...
export interface StratIter284DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter284DStrategy extends BaseIterStrategy<StratIter284DParams> {
  constructor(params: Partial<StratIter284DParams> = {}) {
    super('strat_iter284_d.params.json', { drop_pct: 0.015, stop_loss: 0.15, profit_target: 0.45, max_hold: 25, risk: 0.5 }, params);
  }
