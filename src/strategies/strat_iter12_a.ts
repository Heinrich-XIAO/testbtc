...
export interface StratIter12AParams extends StrategyParams {
...
const defaultParams: StratIter12AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter12AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter12_a.params.json');
...
export class StratIter12AStrategy implements Strategy {
  params: StratIter12AParams;
  ...
  constructor(params: Partial<StratIter12AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter12AParams;
  }
