...
// 2.0% drop, 35% profit, 6% stop, 25 hold
...
export interface StratIter226AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter226AStrategy extends BaseIterStrategy<StratIter226AParams> {
  constructor(params: Partial<StratIter226AParams> = {}) {
    super('strat_iter226_a.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
