...
// 60 bar hold, 40% profit, 12% stop, 50% risk, 2.0% drop
...
export interface StratIter248DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter248DStrategy extends BaseIterStrategy<StratIter248DParams> {
  constructor(params: Partial<StratIter248DParams> = {}) {
    super('strat_iter248_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.4, max_hold: 60, risk: 0.5 }, params);
  }
