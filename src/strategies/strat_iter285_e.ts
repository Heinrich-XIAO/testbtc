...
export interface StratIter285EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter285EStrategy extends BaseIterStrategy<StratIter285EParams> {
  constructor(params: Partial<StratIter285EParams> = {}) {
    super('strat_iter285_e.params.json', { drop_pct: 0.025, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
