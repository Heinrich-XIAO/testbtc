...
export interface StratIter300AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter300AStrategy extends BaseIterStrategy<StratIter300AParams> {
  constructor(params: Partial<StratIter300AParams> = {}) {
    super('strat_iter300_a.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.5, max_hold: 30, risk: 0.2 }, params);
  }
