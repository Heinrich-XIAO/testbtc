...
export interface StratIter13AParams extends StrategyParams {
...
const defaultParams: StratIter13AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter13AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter13_a.params.json');
...
export class StratIter13AStrategy implements Strategy {
  params: StratIter13AParams;
  ...
  constructor(params: Partial<StratIter13AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter13AParams;
  }
