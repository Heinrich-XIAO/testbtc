...
// 2.0% drop, 15% trail, 10% stop, 25 hold, 30% risk
...
export interface StratIter238BParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter238BStrategy extends BaseIterStrategy<StratIter238BParams> {
  constructor(params: Partial<StratIter238BParams> = {}) {
    super('strat_iter238_b.params.json', { drop_pct: 0.02, stop_loss: 0.1, trailing_stop: 0.15, max_hold: 25, risk: 0.3 }, params);
  }
