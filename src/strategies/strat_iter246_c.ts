...
// 45 bar hold, 45% profit, 10% stop, 40% risk, 3.0% drop
...
export interface StratIter246CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter246CStrategy extends BaseIterStrategy<StratIter246CParams> {
  constructor(params: Partial<StratIter246CParams> = {}) {
    super('strat_iter246_c.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.45, max_hold: 45, risk: 0.4 }, params);
  }
