...
export interface StratIter270CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter270CStrategy extends BaseIterStrategy<StratIter270CParams> {
  constructor(params: Partial<StratIter270CParams> = {}) {
    super('strat_iter270_c.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
