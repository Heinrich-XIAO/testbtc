...
// 3.0% drop, 10% trail, 8% stop, 40 hold, 45% risk
...
export interface StratIter239EParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter239EStrategy extends BaseIterStrategy<StratIter239EParams> {
  constructor(params: Partial<StratIter239EParams> = {}) {
    super('strat_iter239_e.params.json', { drop_pct: 0.03, stop_loss: 0.08, trailing_stop: 0.1, max_hold: 40, risk: 0.45 }, params);
  }
