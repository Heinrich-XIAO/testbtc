...
// Grid: 1.0% drop, 10% stop, 25% profit, 35 hold, 30% risk
...
export interface StratIter299CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter299CStrategy extends BaseIterStrategy<StratIter299CParams> {
  constructor(params: Partial<StratIter299CParams> = {}) {
    super('strat_iter299_c.params.json', { drop_pct: 0.01, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
