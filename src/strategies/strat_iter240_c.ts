...
// 1.5% drop, 8% trail, 8% stop, 30 hold, 35% risk
...
export interface StratIter240CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter240CStrategy extends BaseIterStrategy<StratIter240CParams> {
  constructor(params: Partial<StratIter240CParams> = {}) {
    super('strat_iter240_c.params.json', { drop_pct: 0.015, stop_loss: 0.08, trailing_stop: 0.08, max_hold: 30, risk: 0.35 }, params);
  }
