...
export interface StratIter201DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter201DStrategy extends BaseIterStrategy<StratIter201DParams> {
  constructor(params: Partial<StratIter201DParams> = {}) {
    super('strat_iter201_d.params.json', { drop_pct: 0.04, stop_loss: 0.08, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
