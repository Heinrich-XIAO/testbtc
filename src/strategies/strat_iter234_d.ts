...
// 1.0% drop, 5% trail, 6% stop, 35 hold, 40% risk
...
export interface StratIter234DParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter234DStrategy extends BaseIterStrategy<StratIter234DParams> {
  constructor(params: Partial<StratIter234DParams> = {}) {
    super('strat_iter234_d.params.json', { drop_pct: 0.01, stop_loss: 0.06, trailing_stop: 0.05, max_hold: 35, risk: 0.4 }, params);
  }
