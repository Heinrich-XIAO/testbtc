...
export interface StratIter254BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter254BStrategy extends BaseIterStrategy<StratIter254BParams> {
  constructor(params: Partial<StratIter254BParams> = {}) {
    super('strat_iter254_b.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.45, max_hold: 35, risk: 0.7 }, params);
  }
