...
export interface StratIter251DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter251DStrategy extends BaseIterStrategy<StratIter251DParams> {
  constructor(params: Partial<StratIter251DParams> = {}) {
    super('strat_iter251_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
