...
// 60 bar hold, 40% profit, 12% stop, 40% risk, 3.0% drop
...
export interface StratIter248CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter248CStrategy extends BaseIterStrategy<StratIter248CParams> {
  constructor(params: Partial<StratIter248CParams> = {}) {
    super('strat_iter248_c.params.json', { drop_pct: 0.03, stop_loss: 0.12, profit_target: 0.4, max_hold: 60, risk: 0.4 }, params);
  }
