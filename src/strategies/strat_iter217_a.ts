...
// 45% profit, 10% stop, 30 hold, 30% risk
...
export interface StratIter217AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter217AStrategy extends BaseIterStrategy<StratIter217AParams> {
  constructor(params: Partial<StratIter217AParams> = {}) {
    super('strat_iter217_a.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.3 }, params);
  }
