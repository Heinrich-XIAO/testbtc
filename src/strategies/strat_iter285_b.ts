...
// Grid: 1.0% drop, 12% stop, 40% profit, 20 hold, 40% risk
...
export interface StratIter285BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter285BStrategy extends BaseIterStrategy<StratIter285BParams> {
  constructor(params: Partial<StratIter285BParams> = {}) {
    super('strat_iter285_b.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
