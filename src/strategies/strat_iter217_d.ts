...
// 45% profit, 10% stop, 30 hold, 45% risk
...
export interface StratIter217DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter217DStrategy extends BaseIterStrategy<StratIter217DParams> {
  constructor(params: Partial<StratIter217DParams> = {}) {
    super('strat_iter217_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.45, max_hold: 30, risk: 0.45 }, params);
  }
