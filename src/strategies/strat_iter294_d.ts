...
export interface StratIter294DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter294DStrategy extends BaseIterStrategy<StratIter294DParams> {
  constructor(params: Partial<StratIter294DParams> = {}) {
    super('strat_iter294_d.params.json', { drop_pct: 0.015, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
