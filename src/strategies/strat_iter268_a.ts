...
export interface StratIter268AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter268AStrategy extends BaseIterStrategy<StratIter268AParams> {
  constructor(params: Partial<StratIter268AParams> = {}) {
    super('strat_iter268_a.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.4, max_hold: 20, risk: 0.2 }, params);
  }
