...
// 2.0% drop, 35% profit, 6% stop, 45 hold
...
export interface StratIter226EParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter226EStrategy extends BaseIterStrategy<StratIter226EParams> {
  constructor(params: Partial<StratIter226EParams> = {}) {
    super('strat_iter226_e.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.35, max_hold: 45, risk: 0.3 }, params);
  }
