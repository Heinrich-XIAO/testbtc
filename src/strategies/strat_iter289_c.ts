...
export interface StratIter289CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter289CStrategy extends BaseIterStrategy<StratIter289CParams> {
  constructor(params: Partial<StratIter289CParams> = {}) {
    super('strat_iter289_c.params.json', { drop_pct: 0.01, stop_loss: 0.15, profit_target: 0.35, max_hold: 15, risk: 0.5 }, params);
  }
