...
export interface StratIter282AParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter282AStrategy extends BaseIterStrategy<StratIter282AParams> {
  constructor(params: Partial<StratIter282AParams> = {}) {
    super('strat_iter282_a.params.json', { drop_pct: 0.015, stop_loss: 0.12, profit_target: 0.5, max_hold: 30, risk: 0.4 }, params);
  }
