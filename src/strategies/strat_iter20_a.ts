...
export interface StratIter20AParams extends StrategyParams {
...
const defaultParams: StratIter20AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter20AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter20_a.params.json');
...
export class StratIter20AStrategy implements Strategy {
  params: StratIter20AParams;
  ...
  constructor(params: Partial<StratIter20AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter20AParams;
  }
