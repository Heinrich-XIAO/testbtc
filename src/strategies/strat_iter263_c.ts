...
export interface StratIter263CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter263CStrategy extends BaseIterStrategy<StratIter263CParams> {
  constructor(params: Partial<StratIter263CParams> = {}) {
    super('strat_iter263_c.params.json', { drop_pct: 0.03, stop_loss: 0.1, profit_target: 0.25, max_hold: 35, risk: 0.3 }, params);
  }
