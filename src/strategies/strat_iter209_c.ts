...
export interface StratIter209CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter209CStrategy extends BaseIterStrategy<StratIter209CParams> {
  constructor(params: Partial<StratIter209CParams> = {}) {
    super('strat_iter209_c.params.json', { drop_pct: 0.01, stop_loss: 0.10, profit_target: 0.12, max_hold: 25, risk: 0.20 }, params);
  }
