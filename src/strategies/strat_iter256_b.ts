...
// 45% risk, 1.0% drop, 40% profit, 8% stop, 30 hold
...
export interface StratIter256BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter256BStrategy extends BaseIterStrategy<StratIter256BParams> {
  constructor(params: Partial<StratIter256BParams> = {}) {
    super('strat_iter256_b.params.json', { drop_pct: 0.01, stop_loss: 0.08, profit_target: 0.4, max_hold: 30, risk: 0.45 }, params);
  }
