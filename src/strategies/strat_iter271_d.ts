...
export interface StratIter271DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter271DStrategy extends BaseIterStrategy<StratIter271DParams> {
  constructor(params: Partial<StratIter271DParams> = {}) {
    super('strat_iter271_d.params.json', { drop_pct: 0.025, stop_loss: 0.12, profit_target: 0.4, max_hold: 20, risk: 0.4 }, params);
  }
