...
export interface StratIter16AParams extends StrategyParams {
...
const defaultParams: StratIter16AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter16AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter16_a.params.json');
...
export class StratIter16AStrategy implements Strategy {
  params: StratIter16AParams;
  ...
  constructor(params: Partial<StratIter16AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter16AParams;
  }
