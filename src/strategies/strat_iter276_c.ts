...
export interface StratIter276CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter276CStrategy extends BaseIterStrategy<StratIter276CParams> {
  constructor(params: Partial<StratIter276CParams> = {}) {
    super('strat_iter276_c.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
