...
export interface StratIter180AParams extends StrategyParams { stoch_period: number; stoch_oversold: number; stop_loss: number; profit_target: number; max_hold_bars: number; risk_percent: number; }
export class StratIter180AStrategy extends BaseIterStrategy<StratIter180AParams> {
  constructor(params: Partial<StratIter180AParams> = {}) { super('strat_iter180_a.params.json', { stoch_period: 21, stoch_oversold: 20, stop_loss: 0.08, profit_target: 0.15, max_hold_bars: 24, risk_percent: 0.25 }, params); }
