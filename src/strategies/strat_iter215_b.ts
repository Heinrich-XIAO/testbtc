...
// 35% profit, 8% stop, 30 hold, 35% risk
...
export interface StratIter215BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter215BStrategy extends BaseIterStrategy<StratIter215BParams> {
  constructor(params: Partial<StratIter215BParams> = {}) {
    super('strat_iter215_b.params.json', { drop_pct: 0.02, stop_loss: 0.08, profit_target: 0.35, max_hold: 30, risk: 0.35 }, params);
  }
