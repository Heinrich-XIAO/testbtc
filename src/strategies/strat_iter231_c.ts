...
export interface StratIter231CParams extends StrategyParams { drop_pct: number; stop_loss: number; trailing_stop: number; max_hold: number; risk: number; }

export class StratIter231CStrategy extends BaseIterStrategy<StratIter231CParams> {
  constructor(params: Partial<StratIter231CParams> = {}) {
    super('strat_iter231_c.params.json', { drop_pct: 0.01, stop_loss: 0.12, trailing_stop: 0.15, max_hold: 25, risk: 0.3 }, params);
  }
