...
export interface StratIter18CParams extends StrategyParams {
...
const defaultParams: StratIter18CParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 14,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter18CParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter18_c.params.json');
...
export class StratIter18CStrategy implements Strategy {
  params: StratIter18CParams;
  ...
  constructor(params: Partial<StratIter18CParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter18CParams;
  }
