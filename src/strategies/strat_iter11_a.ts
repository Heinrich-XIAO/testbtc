...
export interface StratIter11AParams extends StrategyParams {
...
const defaultParams: StratIter11AParams = {
  stoch_k_period: 14,
  stoch_d_period: 3,
  stoch_oversold: 16,
  stoch_overbought: 86,
...
function loadSavedParams(): Partial<StratIter11AParams> | null {
  const paramsPath = path.join(__dirname, 'strat_iter11_a.params.json');
...
export class StratIter11AStrategy implements Strategy {
  params: StratIter11AParams;
  ...
  constructor(params: Partial<StratIter11AParams> = {}) {
    const savedParams = loadSavedParams();
    this.params = { ...defaultParams, ...savedParams, ...params } as StratIter11AParams;
  }
