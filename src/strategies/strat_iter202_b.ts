...
export interface StratIter202BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter202BStrategy extends BaseIterStrategy<StratIter202BParams> {
  constructor(params: Partial<StratIter202BParams> = {}) {
    super('strat_iter202_b.params.json', { drop_pct: 0.02, stop_loss: 0.06, profit_target: 0.18, max_hold: 15, risk: 0.25 }, params);
  }
