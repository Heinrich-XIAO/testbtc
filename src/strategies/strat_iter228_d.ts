...
// 3.0% drop, 40% profit, 8% stop, 40 hold
...
export interface StratIter228DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter228DStrategy extends BaseIterStrategy<StratIter228DParams> {
  constructor(params: Partial<StratIter228DParams> = {}) {
    super('strat_iter228_d.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 40, risk: 0.3 }, params);
  }
