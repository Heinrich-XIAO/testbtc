...
export interface StratIter270DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter270DStrategy extends BaseIterStrategy<StratIter270DParams> {
  constructor(params: Partial<StratIter270DParams> = {}) {
    super('strat_iter270_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 15, risk: 0.3 }, params);
  }
