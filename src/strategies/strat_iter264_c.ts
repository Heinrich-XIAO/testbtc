...
export interface StratIter264CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter264CStrategy extends BaseIterStrategy<StratIter264CParams> {
  constructor(params: Partial<StratIter264CParams> = {}) {
    super('strat_iter264_c.params.json', { drop_pct: 0.01, stop_loss: 0.12, profit_target: 0.3, max_hold: 40, risk: 0.4 }, params);
  }
