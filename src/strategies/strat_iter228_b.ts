...
// 3.0% drop, 40% profit, 8% stop, 30 hold
...
export interface StratIter228BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter228BStrategy extends BaseIterStrategy<StratIter228BParams> {
  constructor(params: Partial<StratIter228BParams> = {}) {
    super('strat_iter228_b.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.4, max_hold: 30, risk: 0.3 }, params);
  }
