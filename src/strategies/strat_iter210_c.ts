...
export interface StratIter210CParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter210CStrategy extends BaseIterStrategy<StratIter210CParams> {
  constructor(params: Partial<StratIter210CParams> = {}) {
    super('strat_iter210_c.params.json', { drop_pct: 0.03, stop_loss: 0.08, profit_target: 0.18, max_hold: 20, risk: 0.30 }, params);
  }
