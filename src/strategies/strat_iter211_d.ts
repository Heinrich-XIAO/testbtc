...
// 35% profit target with 10% stop loss
...
export interface StratIter211DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter211DStrategy extends BaseIterStrategy<StratIter211DParams> {
  constructor(params: Partial<StratIter211DParams> = {}) {
    super('strat_iter211_d.params.json', { drop_pct: 0.02, stop_loss: 0.1, profit_target: 0.35, max_hold: 25, risk: 0.3 }, params);
  }
