...
export interface StratIter209DParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }
export class StratIter209DStrategy extends BaseIterStrategy<StratIter209DParams> {
  constructor(params: Partial<StratIter209DParams> = {}) {
    super('strat_iter209_d.params.json', { drop_pct: 0.02, stop_loss: 0.12, profit_target: 0.10, max_hold: 20, risk: 0.25 }, params);
  }
