...
export interface StratIter271BParams extends StrategyParams { drop_pct: number; stop_loss: number; profit_target: number; max_hold: number; risk: number; }

export class StratIter271BStrategy extends BaseIterStrategy<StratIter271BParams> {
  constructor(params: Partial<StratIter271BParams> = {}) {
    super('strat_iter271_b.params.json', { drop_pct: 0.015, stop_loss: 0.08, profit_target: 0.3, max_hold: 40, risk: 0.2 }, params);
  }
